    ...
    <Glass pad={0} style={{ flex: 1 }}>
      <div style={{ padding: "20px 8px 16px", textAlign: "center", position: "relative", overflow: "hidden", borderRadius: 22 }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          {unit && <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(15,25,35,0.40)", marginLeft: 2, fontFamily: FONT }}>{unit}</span>}
        </div>
        <div style={{ position: "relative", fontSize: 11.5, color: "rgba(15,25,35,0.40)", marginTop: 4, fontFamily: FONT }}>{label}</div>
      </div>
    </Glass>
  );
}
    ...
    <div style={{
      ...
      {items.map(it => (
        <button key={it} onClick={() => setActive(it)} style={{
          ...
          color: active === it ? "#fff" : "rgba(15,25,35,0.40)", transition: "color .25s",
        }}>{it}</button>
      ))}
    </div>
  );
...
function Row({ label, value, accent, last }) {
  return (
    <div style={{
      ...
      <span style={{ color: "rgba(15,25,35,0.40)", fontSize: 14, fontFamily: FONT }}>{label}</span>
  ...
  return (
    <div onClick={() => !editing && setEditing(true)} style={{
      ...
      {editing ? (
        ...
        <span style={{ fontSize: 15, fontWeight: 700, color: value ? C.text : "rgba(15,25,35,0.20)", fontFamily: FONT }}>
          {displayValue || value || <span style={{ fontSize: 12, fontWeight: 400, color: "rgba(15,25,35,0.20)" }}>Ajouter</span>}
...
function MacroRing({ value, max, label, color }) {
  ...
  return (
    <Glass pad={14} style={{ flex: 1, textAlign: "center" }} glow={`${color}55`}>
      ...
      <div style={{ fontSize: 12, color: "rgba(15,25,35,0.40)", marginTop: 8, fontFamily: FONT }}>{label}</div>
    </Glass>
  );
}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {premium
              ...
              : <span style={{
                  ...
                  color: "rgba(15,25,35,0.28)", letterSpacing: "0.5px", fontFamily: FONT,
                }}>GRATUIT</span>
            }
            {profil.age && profil.sexe && (
              <span style={{ fontSize: 13, color: "rgba(15,25,35,0.40)", fontFamily: FONT }}>
        ...
        <div key="compo">
          <div style={{ display: "flex", gap: 10, marginTop: 22, animation: "rise .4s both" }}>
            <Glass style={{ flex: 1 }}>
              ...
              <span style={{ fontSize: 14, color: "rgba(15,25,35,0.40)", fontWeight: 600 }}> kg</span>
            </Glass>
        ...
        <div key="mesures">
          <Glass style={{ marginTop: 22, display: "flex", alignItems: "center", gap: 16, animation: "rise .4s both" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "rgba(15,25,35,0.40)", marginTop: 3, fontFamily: FONT }}>Appuie sur une ligne pour la modifier</div>
            </div>
          </Glass>
