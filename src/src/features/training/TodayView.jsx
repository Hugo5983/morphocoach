  ...
  return (
    <div style={{ padding: "0 16px" }}>
      ...
      <div style={{ paddingTop: 6, marginBottom: 14 }}>
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "2px", color: "rgba(15,25,35,0.25)", textTransform: "uppercase", fontFamily: DISP, marginBottom: 5 }}>
      ...
      {todaySeance ? (() => {
        ...
        <div style={{
          ...
          <div style={{ fontSize:12.5,color:"rgba(15,25,35,0.55)",lineHeight:1.6,fontFamily:DISP,marginBottom:18 }}>
          ...
          {[
            ...
            <div key={i} onClick={g.tap||undefined} style={{
              ...
              <div style={{ flex:1, minWidth:0 }}>
                ...
                <div style={{ fontSize:11.5, color:"rgba(15,25,35,0.40)", fontFamily:DISP, marginTop:1 }}>{g.s}</div>
              </div>
              ...
              {g.arrow && <div style={{ fontSize:14, color:"rgba(15,25,35,0.22)", flexShrink:0 }}>›</div>}
            </div>
          ))}
          ...
          {rmData.length === 0 ? (
            <div style={{ background: C.s1, border: `1px solid ${C.bd}`, borderRadius: 18, overflow:"hidden" }}>
              ...
              <div style={{ padding:"22px 18px 18px", textAlign:"center" }}>
                ...
                <div style={{ fontSize:11.5,color:"rgba(15,25,35,0.45)",lineHeight:1.6,marginBottom:16,fontFamily:DISP }}>
      ...
      {!prog && (
        <Card style={{ textAlign: "center", padding: "20px 16px", marginTop: 8 }}>
          <div style={{ fontSize: 12, color: "rgba(15,25,35,0.50)", marginBottom: 12 }}>Aucun programme actif</div>
            ...
            <div onClick={e=>e.stopPropagation()} style={{
              ...
              <div style={{ padding:"18px 22px 0",display:"flex",alignItems:"center",justifyContent:"space-between" }}>
                ...
                <button onClick={()=>setShowSleepModal(false)} style={{
                  ...
                  border:"1px solid rgba(0,0,0,0.06)",color:"rgba(15,25,35,0.55)",
              ...
              <div style={{ padding:"0 22px" }}>
                ...
                <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
                  ...
                  <button onClick={()=>saveSleepTarget(stepD(sleepTarget))} style={{
                    ...
                    border:"none",color:"rgba(15,25,35,0.55)",fontSize:18,cursor:"pointer",
                    display:"grid",placeItems:"center",
                  }}>−</button>
                  <div style={{ textAlign:"center" }}>
                    <div style={{ fontSize:36,fontWeight:700,color:"${C.text}",letterSpacing:-1,fontFamily:F }}>
                      {sleepTarget}<span style={{ fontSize:16,color:"rgba(15,25,35,0.45)",marginLeft:3 }}>h</span>
                    </div>
                ...
                <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
                  ...
                  <div style={{ textAlign:"center" }}>
                    <div style={{ fontSize:36,fontWeight:700,color:"${C.text}",letterSpacing:-1,fontFamily:F }}>
                      {inputVal}<span style={{ fontSize:16,color:"rgba(15,25,35,0.45)",marginLeft:3 }}>h</span>
                    </div>
