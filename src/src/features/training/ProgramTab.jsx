        ...
        {WEEKS.map((w,i) => {
          ...
          return (
            <div key={i} style={{flex:1,textAlign:"center"}}>
              ...
              <div style={{fontSize:8,color:"rgba(15,25,35,0.22)",fontFamily:DISP_F,marginTop:1}}>{w.type}</div>
            </div>
          );
        })}
      </div>
          ...
          <div style={{position:"relative",display:"flex",gap:7,alignItems:"flex-end",height:120,margin:"16px 0 8px"}}>
            ...
            {WEEKS.map((w,i)=>{
              ...
              return <div key={i} style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end",alignItems:"center",gap:4,zIndex:2}}>
                ...
                <div style={{fontSize:10,fontWeight:700,color:isCur?col:"rgba(15,25,35,0.3)",fontFamily:DISP_F}}>{w.lbl}</div>
              </div>;
            })}
          </div>
        ...
        {card("ready", (() => {
          ...
          return <>
            ...
            <div style={{display:"flex",alignItems:"center",gap:18,marginTop:4}}>
              ...
              <div style={{position:"relative",width:90,height:90,flexShrink:0}}>
                ...
                <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
                  ...
                  <div style={{fontSize:8,color:"rgba(15,25,35,0.3)",letterSpacing:1,textTransform:"uppercase",marginTop:2}}>/ 100</div>
                </div>
              </div>
              {/* Barres */}
              <div style={{flex:1,display:"flex",flexDirection:"column",gap:10}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:9}}>
                  <span style={{fontSize:11,color:"rgba(15,25,35,0.55)",width:76,flexShrink:0,fontFamily:DISP_F}}>Sommeil 7j</span>
                ...
                {/* Mobilité */}
                <div style={{display:"flex",alignItems:"center",gap:9}}>
                  <span style={{fontSize:11,color:"rgba(15,25,35,0.55)",width:76,flexShrink:0,fontFamily:DISP_F}}>Mobilité 7j</span>
                  <div style={{flex:1,height:6,borderRadius:3,background:"rgba(0,0,0,0.05)",overflow:"hidden"}}>
                    <div style={{height:"100%",borderRadius:3,
                      width:`${mobPct}%`,
            ...
            {detailBox("ready", <>
              ...
              <div style={{marginTop:10,fontSize:11,color:"rgba(15,25,35,0.4)",fontStyle:"italic"}}>
        ...
        {card("acwr", (() => {
          ...
          return <>
            ...
            <div style={{position:"relative",height:30,margin:"16px 0 16px"}}>
              ...
              <div style={{position:"absolute",bottom:-12,left:0,right:0,display:"flex",justifyContent:"space-between",fontSize:8,color:"rgba(15,25,35,0.3)"}}><span>0.5</span><span>0.8</span><span style={{color:"#34D399"}}>1.0</span><span>1.3</span><span>1.5+</span></div>
            </div>
            {hasRatio && (
        ...
        {card("rm", (() => {
          ...
          return <>
            ...
            {hasProg ? (
                  ...
                  {realWeeks.map((v,k) => {
                    ...
                    return (
                      <div key={k} style={{flex:1,textAlign:"center"}}>
                        <div style={{fontSize:12,fontWeight:isCur?800:700,color:isReal?(isCur?"#60A5FA":"#60A5FA"):"rgba(15,25,35,0.20)"}}>
                          {v?<>{v}<span style={{fontSize:8,opacity:.6}}>kg</span></>:"—"}
                        </div>
                        <div style={{fontSize:8,color:"rgba(15,25,35,0.3)",marginTop:1}}>{WEEKS[k]?.lbl}</div>
                      </div>
                    );
                  })}
                </div>
              ...
              <div style={{marginTop:14,padding:"14px",background:"rgba(59,130,246,0.05)",border:"1px dashed rgba(59,130,246,0.2)",borderRadius:12,fontSize:12,color:"rgba(15,25,35,0.40)",textAlign:"center",fontFamily:DISP_F}}>
    ...
    <div style={{padding:"0 15px"}}>
      ...
      {confirmDel && (
        <div style={{position:"fixed",inset:0,background:"rgba(15,26,46,0.55)",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div style={{background:C.s1,borderRadius:16,padding:"22px 20px",width:"100%",maxWidth:340}}>
            ...
            <div style={{fontSize:12,color:"rgba(15,25,35,0.50)",marginBottom:20,lineHeight:1.5}}>
            ...
            <div style={{display:"flex",gap:10}}>
              <button onClick={()=>setConfirmDel(null)} style={{flex:1,padding:"10px",background:C.s2,border:"none",borderRadius:9,cursor:"pointer",fontSize:13,fontWeight:500,color:"rgba(15,25,35,0.50)",fontFamily:DISP_F}}>Annuler</button>
            ...
            <div key={jIdx} style={{background:C.s1,border:`1px solid ${isOpen?int.c+"40":C.bd}`,borderRadius:18,marginBottom:10,overflow:"hidden",transition:"border-color .2s"}}>
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"13px 14px",cursor:"pointer"}} onClick={()=>setOpenJour(isOpen?null:jIdx)}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:6,marginTop:3,fontSize:11.5,color:"rgba(15,25,35,0.55)",fontFamily:DISP_F}}>
                ...
                <div style={{color:"rgba(15,25,35,0.40)",fontSize:18,transition:"transform .2s",transform:isOpen?"rotate(180deg)":"rotate(0)",flexShrink:0}}>⌄</div>
              </div>
              {isOpen && (
                  ...
                  {exos.length===0
                    ...
                    : exos.map((ex,k) => (
                      <div key={k} style={{display:"flex",alignItems:"flex-start",gap:11,padding:"9px 0",borderBottom:k<exos.length-1?"1px solid rgba(0,0,0,0.03)":"none"}}>
                        ...
                        <div style={{fontSize:12,fontWeight:600,color:"rgba(15,25,35,0.45)",fontFamily:DISP_F,flexShrink:0,marginTop:2,textAlign:"right",whiteSpace:"nowrap"}}>
            ...
            return (
              <div key={pIdx} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:C.s1,border:`1px solid ${C.bd}`,borderRadius:12,marginBottom:6}}>
                <div style={{flex:1,minWidth:0}}>
                  ...
                  <div style={{fontSize:10.5,color:"rgba(15,25,35,0.40)",marginTop:1}}>{p.jours?.length||0} séances</div>
                </div>
      ...
      {allProgs.length === 0 && !showCreerForm && (
        <div style={{textAlign:"center",padding:"32px 0 16px"}}>
          ...
          <div style={{fontSize:12,color:"rgba(15,25,35,0.45)",lineHeight:1.6,maxWidth:240,margin:"0 auto 24px",fontFamily:DISP_F}}>Génère un programme IA adapté à ta morphologie ou crée-le manuellement.</div>
        </div>
      )}
