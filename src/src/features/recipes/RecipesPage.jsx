    ...
    <div onClick={() => onOpen(r)} className="tap" style={{
      ...
      <div style={{ position:"relative", height:110, background:C.s2 }}>
        ...
        <button
          ...
          <svg width="13" height="13" viewBox="0 0 24 24"
               ...
               stroke={liked ? "#F87171" : "rgba(15,25,35,0.75)"}
      ...
      <div style={{ padding:"10px 10px 12px" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:6 }}>
          <span style={{ fontSize:11, color:"rgba(15,25,35,0.40)",
      ...
      <div style={{ paddingTop:20, paddingBottom:14,
        ...
        <button style={{ width:34, height:34, borderRadius:10,
          ...
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
               stroke="rgba(15,25,35,0.55)" strokeWidth="1.8" strokeLinecap="round">
      ...
      {!premium && (
        <div onClick={() => setPaywall && setPaywall(true)} style={{
          ...
          <div style={{ flex:1 }}>
            ...
            <div style={{ fontSize:11.5, color:"rgba(15,25,35,0.50)",
      ...
      <div style={{ display:"flex", gap:8, marginBottom:14 }}>
        <div style={{ flex:1, display:"flex", alignItems:"center", gap:8,
          ...
          {search && (
            <button onClick={() => setSearch("")} style={{ background:"none",
              border:"none", cursor:"pointer", color:"rgba(15,25,35,0.40)",
        ...
        <button style={{ width:40, height:40, background:C.s1,
          ...
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
               stroke="rgba(15,25,35,0.55)" strokeWidth="2" strokeLinecap="round">
        ...
        {FILTRES.map(f => {
          ...
          return (
            <button key={f.id} onClick={() => setFiltre(f.id)} className="tap" style={{
              ...
              color: on ? "#fff" : "rgba(15,25,35,0.55)",
            ...
            <div style={{ position:"relative", height:150, background:C.s2 }}>
              ...
              <button
                ...
                <svg width="14" height="14" viewBox="0 0 24 24"
                     ...
                     stroke={liked[featured.id] ? "#F87171" : "rgba(15,25,35,0.75)"}
                     strokeWidth="2" strokeLinecap="round">
                  <path d="M12 20s-7-4.5-7-10a4 4 0 0 1 7-2.5A4 4 0 0 1 19 10c0 5.5-7 10-7 10z"/>
                </svg>
              </button>
