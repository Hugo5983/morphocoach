      ...
      <div style={{ padding:16 }}>
          ...
          {[
            ...
            <div key={s.l} style={{ flex:1, background:C.s1,
              ...
              <div style={{ fontFamily:SERIF, fontSize:20, color:"${C.text}",
                transition:"all .2s" }}>
                {s.v}<span style={{ fontSize:11, color:"rgba(15,25,35,0.40)" }}>{s.u}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{ background:C.s1, border:"1px solid rgba(0,0,0,0.06)",
          ...
          <div style={{ display:"flex", justifyContent:"space-between",
            ...
            <div>
              ...
              <div style={{ display:"flex", alignItems:"baseline", gap:6 }}>
                ...
                <span style={{ fontSize:12, color:"rgba(15,25,35,0.40)",
          ...
          <div style={{ display:"flex", justifyContent:"space-between",
            ...
            <span style={{ color:"rgba(15,25,35,0.50)" }}>Base : {base} kcal</span>
            ...
            {[
              ...
              <div key={m.l} style={{ flex:1, background:m.bg,
                ...
                <div style={{ display:"flex", alignItems:"center", justifyContent:"center",
                  ...
                  <span style={{ fontSize:10, color:"rgba(15,25,35,0.50)",
          ...
          {targetKcal && targetKcal !== base && (
            <button className="tap" onClick={() => setTargetKcal(null)} style={{
              ...
              color:"rgba(15,25,35,0.40)", fontSize:12, fontWeight:500,
          ...
          {r.ingredients.map((ing, i) => (
            <div key={i} style={{ display:"flex", justifyContent:"space-between",
              ...
              <span style={{ fontSize:13, fontWeight:600,
                color: targetKcal && targetKcal !== base ? "#93C5FD" : "rgba(15,25,35,0.50)",
        ...
        <div style={{ display:"flex", flexDirection:"column",
          ...
          {r.etapes.map((etape, i) => (
            <div key={i} style={{ display:"flex", gap:12 }}>
              ...
              <div style={{ fontSize:13, color:"rgba(15,25,35,0.75)",
