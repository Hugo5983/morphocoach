    ...
    <div>
      <div style={{ display:"flex", justifyContent:"space-between",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:7 }}>
          ...
          <span style={{ fontSize:12.5, color:"rgba(15,25,35,0.55)",
            fontFamily:FONT, fontWeight:500 }}>{label}</span>
        </div>
        <div style={{ display:"flex", alignItems:"baseline", gap:3 }}>
          <span style={{ fontSize:13, fontWeight:700, color:"${C.text}",
            fontFamily:FONT, ...NUM }}>{value}</span>
          <span style={{ fontSize:11, color:"rgba(15,25,35,0.28)",
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:8,
        ...
        {locked.map(f => (
          <div key={f} style={{ display:"flex", alignItems:"center", gap:9 }}>
            ...
            <span style={{ fontSize:13, color:"rgba(15,25,35,0.55)",
    ...
    <div className="anim" style={{ padding:"0 16px 28px" }}>
          ...
          <div style={{ marginTop:10, display:"flex", alignItems:"center", gap:7, flexWrap:"wrap" }}>
            ...
            {cycleStart && jR !== null && (
              <span style={{
                ...
                fontSize:11.5, color:"rgba(15,25,35,0.55)",
      ...
      {streak > 0 && (
        <Card className="pop-in" padding="none" style={{
          ...
          <div>
            ...
            <div style={{ fontSize:12, color:"rgba(15,25,35,0.45)", marginTop:2, fontFamily:FONT }}>
      ...
      <Card padding="none" style={{
        ...
        <div style={{ fontFamily:SERIF, fontStyle:"italic", fontSize:14,
          color:"rgba(15,25,35,0.85)", lineHeight:1.6 }}>"{motiv}"</div>
      </Card>
      ...
      {todaySess ? (
        ...
        <Card onClick={() => goProgram("creer")} className="tap" padding="none" style={{
          ...
          <div style={{ flex:1 }}>
            ...
            <div style={{ fontSize:12, color:"rgba(15,25,35,0.45)",
        ...
        <Card padding="none" style={{
          ...
          <div style={{ display:"flex", justifyContent:"space-between",
            ...
            <button className="tap" onClick={() => setTab("nutrition")} style={{
              ...
              color:"rgba(15,25,35,0.45)", fontSize:11, fontFamily:FONT,
          ...
          <div style={{ display:"flex", alignItems:"center", gap:18 }}>
            ...
            <div style={{ position:"relative", width:132, height:132, flexShrink:0 }}>
              ...
              <div style={{ position:"absolute", inset:0, display:"flex",
                ...
                <div style={{ fontSize:10, color:"rgba(15,25,35,0.40)",
