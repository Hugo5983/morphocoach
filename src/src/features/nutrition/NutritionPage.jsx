                ...
                {isToday&&(
                  <div style={{display:'flex',alignItems:'center',gap:8}}>
                    ...
                    <button className="tap" onClick={()=>setShowPhoto(true)} style={{
                      ...
                      borderRadius:12,
                      color: premium ? '#A5B4FC' : 'rgba(15,25,35,0.50)',
                      fontSize:12.5,fontWeight:700,fontFamily:DISPLAY,cursor:'pointer',
                    }}>
                      {!premium
          ...
          <div style={{padding:'16px 16px 0',paddingBottom:32}}>
            ...
            <div style={{background:C.s1,border:`1px solid ${C.bd}`,borderRadius:20,padding:'22px 20px 18px',marginBottom:10,position:'relative',overflow:'hidden'}}>
              ...
              <div style={{display:'flex',alignItems:'flex-end',justifyContent:'space-between',marginBottom:18}}>
                <div>
                  ...
                  <div style={{fontSize:11,color:'rgba(15,25,35,0.45)',marginTop:4,maxWidth:180,lineHeight:1.4,fontFamily:DISPLAY}}>
              ...
              <div>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}>
                  {['E','D','C','B','A'].map(l=>(
                    <span key={l} style={{fontSize:9,color:l===scoreLettre?scoreColor:'rgba(15,25,35,0.20)',fontWeight:l===scoreLettre?700:400,fontFamily:DISPLAY}}>{l}</span>
                  ))}
                </div>
              </div>
            </div>
                  ...
                  <div key={d.id} style={{padding:'14px 0',borderBottom:i<scoreDetails.length-1?`1px solid rgba(0,0,0,0.04)`:'none'}}>
                    <div style={{display:'flex',alignItems:'center',gap:12}}>
                      ...
                      <div style={{flex:1,minWidth:0}}>
                        ...
                        <div style={{fontSize:11,color:'rgba(15,25,35,0.45)',fontFamily:DISPLAY,marginBottom:4}}>{d.value}</div>
                        {/* Mini barre de pts */}
                    ...
                    {/* Conseil contextuel */}
                    {d.status!=='ok'&&(
                      <div style={{marginTop:8,marginLeft:52,fontSize:11,color:'rgba(15,25,35,0.45)',fontStyle:'italic',fontFamily:DISPLAY,lineHeight:1.5}}>
                        💡 {d.tip}
                      </div>
                    )}
                  </div>
            ...
            <div style={{background:'rgba(59,130,246,0.07)',border:'1px solid rgba(59,130,246,0.18)',borderRadius:16,padding:'14px 16px',display:'flex',alignItems:'flex-start',gap:10}}>
              ...
              <div>
                ...
                <div style={{fontSize:11,color:'rgba(15,25,35,0.45)',fontFamily:DISPLAY,lineHeight:1.5}}>
