    ...
    <div style={{
      ...
      <Card padding="none" variant="accent" style={{
        ...
        <button onClick={onClose} style={{
          ...
          color:"rgba(15,25,35,0.45)", fontSize:18,
        ...
        <div style={{ textAlign:"center", marginBottom:18, position:"relative" }}>
          ...
          <div style={{ fontSize:12, color:"rgba(15,25,35,0.50)", fontFamily:FONT, lineHeight:1.55 }}>
          ...
          {FEATURES.map((f, i) => (
            <div key={i} style={{
              ...
              <div style={{ flex:1 }}>
                ...
                <div style={{ fontSize:11, color:"rgba(15,25,35,0.45)", marginTop:1, fontFamily:FONT }}>{f.sub}</div>
              </div>
              <div style={{
        ...
        <div style={{ textAlign:"center", marginBottom:16 }}>
          <div style={{ display:"flex", alignItems:"baseline", justifyContent:"center", gap:6 }}>
            ...
            <span style={{ fontSize:13, color:"rgba(15,25,35,0.45)", fontFamily:FONT }}>/cycle</span>
          </div>
