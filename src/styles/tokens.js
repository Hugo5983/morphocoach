...
export const TYPE = {
  display:   { fontFamily: FONT, fontSize: 32, fontWeight: 800, lineHeight: 1.1,  letterSpacing:"-0.02em" }, // grands chiffres hero (avec NUM)
  h1:        { fontFamily: FONT, fontSize: 25, fontWeight: 700, lineHeight: 1.15, letterSpacing:"-0.02em" }, // titre de page
  h2:        { fontFamily: FONT, fontSize: 21, fontWeight: 700, lineHeight: 1.2,  letterSpacing:"-0.01em" }, // titre de carte hero
  h3:        { fontFamily: FONT, fontSize: 16, fontWeight: 700, lineHeight: 1.3,  letterSpacing:"-0.01em" }, // titre de carte / ligne de liste
  ...
  caption:   { fontFamily: FONT, fontSize: 12, fontWeight: 500, lineHeight: 1.35, letterSpacing: 0 },         // méta, unités, dates
  micro:     { fontFamily: FONT, fontSize: 11, fontWeight: 600, lineHeight: 1.3,  letterSpacing:"0.08em", textTransform:"uppercase" }, // eyebrows, labels
};
...
export const RADIUS = {
  sm:   6,    // chips, tags, inputs compacts
  md:   10,   // boutons, inputs
...
// ─── SHADOWS — 3 niveaux, direction Précision ────────────────────────────────
export const SHADOW = {
  low:"0 1px 2px rgba(16,19,24,0.04)",   // = C.shadow — cartes au repos
  medium:"0 4px 12px rgba(16,19,24,0.06)",  // = C.shadowMd — dropdowns
  high:"0 12px 32px rgba(16,19,24,0.14)", // modales, sheets, éléments flottants
  accent:"none",                            // supprimée — pas de glow sur les CTA
};
...
export const BORDER = {
  ...
  accent:`1px solid rgba(60,91,255,0.25)`,      // cartes accent
  focus:`1px solid rgba(60,91,255,0.50)`,      // états focus
};
