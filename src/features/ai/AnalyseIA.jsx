    ...
    <div style={{ paddingBottom:32 }}>
      ...
      {aStep===0 && <>
        ...
        <div style={{ padding:'18px 20px 0' }}>
          ...
          <div style={{ ...CARD, padding:'12px 14px', display:'flex', gap:12,
            alignItems:'center', marginBottom:16,
            background:'rgba(59,130,246,0.07)', border:`1px solid rgba(59,130,246,0.22)` }}>
            <div style={{ width:34, height:34, borderRadius:10, background:T.ac,
              display:'grid', placeItems:'center', flexShrink:0,
              boxShadow:`0 4px 10px ${T.acGlow}` }}>
              <OI n="shield" sz={17} c="#fff" s={2}/>
            </div>
            <span style={{ fontSize:11.5, color:T.t2, fontWeight:500, lineHeight:1.5 }}>
