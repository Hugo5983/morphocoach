...
function OI({ n, sz=18, c='currentColor', s=1.6 }) {
  ...
  const P = {
    ...
    muscle:  <><path d="M4 15v-2.5A2.5 2.5 0 0 1 6.5 10H10a2 2 0 0 0 2-2V6.5a2.5 2.5 0 0 1 5 0c0 5-3.5 8.5-8.5 8.5"/><path d="M4 15a2.5 2.5 0 0 0 2.5 2.5H9a1.5 1.5 0 0 1 1.5 1.5V21"/><path d="M12 10.5a4 4 0 0 0 3 3.5"/></>,
    ...
    // ── Zones corps (cohérentes : colonne / articulation / charnière) ──────────
    spine:   <><rect x="9.5" y="2.6" width="5" height="3" rx="1.3"/><rect x="9.5" y="7" width="5" height="3" rx="1.3"/><rect x="9.5" y="11.4" width="5" height="3" rx="1.3"/><rect x="9.5" y="15.8" width="5" height="3" rx="1.3"/><path d="M8 4.1h-1M16 4.1h1M8 8.5h-1M16 8.5h1M8 12.9h-1M16 12.9h1"/></>,
    shoulder:<><path d="M3 19v-2a9 9 0 0 1 18 0v2"/><circle cx="12" cy="7" r="3.4"/></>,
    knee:    <><path d="M9 3v6a4 4 0 0 0 4 4h5"/><path d="M9 13v8"/><circle cx="9" cy="11" r="2.4"/></>,
...
function Silhouette({ view }) {
  const fill = T.acSoft, stroke = T.acLt;
  const s = { fill, stroke, strokeWidth:1.4, strokeLinejoin:'round', strokeLinecap:'round' };
  return (
    <svg width="50" height="90" viewBox="0 0 56 96">
      {view === 'face' && <>
        <circle cx="28" cy="12" r="8" {...s}/>
        <path d="M13 24 H43 L40 47 H16 Z" {...s}/>
        <rect x="7.5" y="25" width="5.5" height="27" rx="2.7" {...s}/>
        <rect x="43"  y="25" width="5.5" height="27" rx="2.7" {...s}/>
        <rect x="18"  y="46" width="7"   height="44" rx="3.5" {...s}/>
        <rect x="31"  y="46" width="7"   height="44" rx="3.5" {...s}/>
      </>}
      {view === 'dos' && <>
        <circle cx="28" cy="12" r="8" {...s}/>
        <path d="M13 24 H43 L40 47 H16 Z" {...s}/>
        ...
        <rect x="18"  y="46" width="7"   height="44" rx="3.5" {...s}/>
        <rect x="31"  y="46" width="7"   height="44" rx="3.5" {...s}/>
        {/* colonne + omoplates = vue de dos */}
        <path d="M28 27 V44" fill="none" stroke={stroke} strokeWidth="1.4"/>
        <path d="M22.5 30 l3.5 3.5 M33.5 30 l-3.5 3.5" fill="none" stroke={stroke} strokeWidth="1.2"/>
      </>}
      {view === 'profil' && <>
        <circle cx="25" cy="12" r="8" {...s}/>
        {/* nez = sens du profil */}
        <path d="M17.5 11 l-2.2 1.4 2.2 1.4" fill="none" stroke={stroke} strokeWidth="1.3"/>
        <path d="M20 24 H31 L29 47 H21 Z" {...s}/>
        <rect x="26.5" y="25" width="5" height="26" rx="2.5" {...s}/>
        <rect x="24"  y="46" width="7" height="44" rx="3.5" {...s} opacity="0.8"/>
        <rect x="19"  y="46" width="7" height="44" rx="3.5" {...s}/>
      </>}
    </svg>
  );
}
