...
export default function ProgrammeView(props) {
  ...
  return (
    <div style={{padding:"0 16px"}}>
      ...
      {confirmDel && (
        <div style={{position:"fixed",inset:0,background:"rgba(15,26,46,0.55)",zIndex:340,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
            ...
            <div style={{display:"flex",alignItems:"flex-start",padding:"20px 16px 20px 20px",gap:12,position:"relative",zIndex:1}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{display:"inline-flex",alignItems:"center",gap:4,
                  ...
                  <span style={{fontSize:10,fontWeight:700,color:"#C4B5FD",fontFamily:F2,letterSpacing:"0.8px"}}>PRO · IA Coach</span>
                ...
                <button onClick={()=>{ if(!premium) setPaywall(true); else setProgView("analyse"); }}
                  style={{width:"100%",padding:"16px 12px",borderRadius:16,cursor:"pointer",
                    ...
                    color:"rgba(255,255,255,0.88)",fontSize:16,fontWeight:700,fontFamily:F2,
              ...
              <div style={{position:"relative",flexShrink:0,
                ...
                <div style={{position:"relative",zIndex:1,width:118,borderRadius:20,
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:8,borderRadius:12,padding:"8px 8px",
                    marginBottom:8,background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.07)"}}>
                  ...
                  <div style={{height:2,borderRadius:1,background:"rgba(255,255,255,0.15)",margin:"8px 20px 0"}}/>
                </div>
              </div>
            </div>
          </div>
          ...
          return (
            <div key={jIdx} style={{
              ...
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"16px 16px",cursor:"pointer"}}
                ...
                {/* Badge jour */}
                <div style={{width:50,height:50,borderRadius:16,background:int.c,color:"#FFF",
                ...
                <div style={{borderTop:`1px solid ${C.bd}`,padding:"8px 16px 16px"}}>
                  ...
                  <button onClick={e=>{e.stopPropagation();setSelectedJour({jIdx});}}
                    style={{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",
                      ...
                      borderRadius:12,cursor:"pointer",marginBottom:12,color:"#60A5FA",
                  ...
                  {exos.length===0
                    ...
                    : exos.map((ex,k) => (
                      <div key={k} style={{display:"flex",alignItems:"flex-start",gap:12,padding:"8px 0",borderBottom:k<exos.length-1?"1px solid rgba(0,0,0,0.03)":"none"}}>
                        ...
                        <div style={{flex:1,minWidth:0}}>
                          ...
                          <div style={{fontSize:10,fontWeight:700,letterSpacing:"1px",color:C.dim,textTransform:"uppercase",fontFamily:DISP_F,marginTop:2}}>{ex.cat||"Principal"}</div>
                        </div>
      ...
      <div style={{fontSize:20,fontWeight:700,color:C.text,fontFamily:DISP_F,marginTop:20,marginBottom:12,letterSpacing:"-0.4px"}}>
      ...
      {allProgs.length > 1 && (
        <div style={{marginBottom:16}}>
          <div style={{fontSize:10,fontWeight:700,letterSpacing:"1.3px",textTransform:"uppercase",color:C.blue,fontFamily:DISP_F,marginBottom:12}}>Autres programmes</div>
          {allProgs.map((p, pIdx) => {
            ...
            return (
              <div key={pIdx} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 12px",background:C.s1,border:`1px solid ${C.bd}`,borderRadius:12,marginBottom:8}}>
                ...
                <button onClick={()=>{setProg(p);push("✅","Programme activé",p.titre);}} style={{padding:"8px 12px",background:"rgba(52,211,153,0.10)",border:"1px solid rgba(52,211,153,0.25)",borderRadius:8,color:"#34D399",cursor:"pointer",fontSize:10,fontWeight:700,fontFamily:DISP_F}}>Activer</button>
                <button onClick={()=>setConfirmDel({type:"prog",pIdx})} style={{padding:"8px 8px",background:"rgba(248,113,113,0.07)",border:"1px solid rgba(248,113,113,0.18)",borderRadius:8,color:"#FF7A6B",cursor:"pointer",fontSize:11}}>🗑</button>
              </div>
            );
          })}
        </div>
