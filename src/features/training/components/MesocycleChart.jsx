...
export default function MesocycleChart({ prog, semC, checkedEx, cycleStart }) {
  ...
  return (
    ...
    <div onClick={()=>setOpen(true)}
          ...
          {hasCharge ? (
            <>
              <div style={{display:"flex",alignItems:"baseline",gap:8,marginBottom:4}}>
                <span style={{fontSize:26,fontWeight:700,color:C.text,fontFamily:DISP_F,letterSpacing:"-1px"}}>
      ...
      <div style={{display:"flex"}}>
        ...
        <div style={{position:"relative"}}>
          ...
          <div style={{position:"relative",zIndex:1,textAlign:"center",padding:"32px 0 0"}}>
            <div style={{fontSize:10,fontWeight:700,color:C.accent,textTransform:"uppercase",letterSpacing:"0.7px",fontFamily:DISP_F,marginBottom:8}}>
              📊 Aucune donnée
            </div>
            <div style={{fontSize:16,fontWeight:700,color:C.text,fontFamily:DISP_F,letterSpacing:"-0.3px",marginBottom:8}}>
      ...
      {hasCharge && (
      <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8,marginTop:16,paddingTop:12,borderTop:`1px solid ${C.bd}`,color:"#60A5FA",fontSize:13,fontWeight:700,fontFamily:DISP_F}}>
