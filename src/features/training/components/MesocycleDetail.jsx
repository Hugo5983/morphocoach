    ...
    >
      <div style={{padding:"0 16px 32px",maxWidth:480,margin:"0 auto"}}>
        ...
        {card("over", (() => {
          ...
          const signals = [
            { ic:"chart",    t:"Performance", s:perfLabel, st:perfBadge[2], col:perfBadge[1], bg:perfBadge[0] },
            { ic:"sleep",    t:"Sommeil",     s:slpLabel,  st:slpBadge[2],  col:slpBadge[1],  bg:slpBadge[0]  },
            { ic:"heart",    t:"FC repos",    s:"Connecte une app santé",   st:"–", col:"#888", bg:"rgba(138,148,166,0.12)" },
            { ic:"spark",    t:"Motivation",  s:"Check-in hebdo à venir",   st:"–", col:"#888", bg:"rgba(138,148,166,0.12)" },
          ];
            ...
            <div style={{marginTop:16}}>
              {signals.map(({ic,t,s,st,col,bg},k)=>(
                <div key={k} style={{display:"flex",alignItems:"center",gap:12,padding:"8px 0",borderBottom:k<3?"1px solid rgba(0,0,0,0.05)":"none"}}>
                  <div style={{width:34,height:34,borderRadius:12,background:bg,display:"grid",placeItems:"center",flexShrink:0}}>
                    <I name={ic} size={16} color={col} stroke={2}/>
                  </div>
                  <div style={{flex:1}}>
