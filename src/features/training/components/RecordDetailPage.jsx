...
export default function RecordDetailPage({ exData, prog, setProg, push, onClose }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, zIndex:320,
      ...
      {/* Header */}
      <div style={{ padding:"20px 20px 12px", background:S1,
      ...
      <div style={{ flex:1, overflowY:"auto", WebkitOverflowScrolling:"touch", padding:"0 0 32px" }}>
        ...
        <div style={{ padding:"20px 20px 16px" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:16 }}>
            <div>
              <div style={{ fontSize:8.5, fontWeight:700, letterSpacing:"1.5px", textTransform:"uppercase",
                color:GRY, marginBottom:4 }}>Record 1RM</div>
              <div style={{ display:"flex", alignItems:"baseline", gap:4 }}>
                <span style={{ fontSize:34, fontWeight:700, color:TEXT, letterSpacing:"-1.5px", ...NUM }}>
                  {currentRM || "—"}
                </span>
          ...
          {showObjInput && (
            <div style={{ display:"flex", gap:8, marginTop:12 }}>
              <input type="number" inputMode="decimal" value={objKgInput}
                ...
                style={{ flex:1, padding:"12px 12px", borderRadius:12, border:`1.5px solid rgba(59,130,246,0.4)`,
        ...
        <div style={{ margin:"0 20px 16px", background:S1, border:`1px solid ${BD}`,
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
            ...
            <div style={{ flex:1, position:"relative" }}>
              ...
              <div style={{ display:"flex", alignItems:"baseline", gap:4 }}>
                <span style={{ fontSize:44, fontWeight:700, letterSpacing:"-2px",
          ...
          <div style={{ padding:"0 16px 16px" }}>
            <button onClick={handleSave} disabled={!canSave}
              style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8,
                width:"100%", height:46, borderRadius:12, border:"none", fontFamily:F,
        ...
        <div style={{ margin:"0 20px 16px", background:S1, border:`1px solid ${BD}`,
          ...
          <div style={{ display:"flex", alignItems:"baseline", justifyContent:"space-between", marginBottom:12 }}>
            <div style={{ fontSize:8, fontWeight:700, letterSpacing:"1.5px",
