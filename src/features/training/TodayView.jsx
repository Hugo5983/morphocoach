          ...
          {[
            {
              ...
              glow: "0 4px 14px rgba(16,185,129,0.5)",
              t:  "Hydratation · 2,5 L",
            ...
            },
            {
              ...
              glow: todaySleepLogged !== null
                ? todaySleepLogged >= sleepTarget ? "0 4px 14px rgba(16,185,129,0.5)" : todaySleepLogged >= sleepTarget-1.5 ? "0 4px 14px rgba(245,158,11,0.5)" : "0 4px 14px rgba(239,68,68,0.5)"
            ...
            },
            {
              ...
              bd: "rgba(255,255,255,0.25)",
              glow: todayMobilite ? "0 4px 14px rgba(16,185,129,0.5)" : "0 4px 14px rgba(37,99,235,0.5)",
            ...
            <div key={i} onClick={g.tap||undefined} style={{
              ...
              <div style={{
                ...
                boxShadow: g.flash ? "0 0 18px rgba(52,211,153,0.65)" : (g.glow || "none"),
              }}>{g.ic}</div>
              <div style={{ flex:1, minWidth:0 }}>
              ...
              {g.badge && (
                <div style={{
                  ...
                  border: `1.5px solid ${todayMobilite ? "rgba(52,211,153,0.5)" : "rgba(170,180,255,0.35)"}`,
                  display:"grid", placeItems:"center",
                  transition:"all .2s",
                }}>
                  {todayMobilite
