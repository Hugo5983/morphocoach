...
export default function TodayView(props) {
  ...
  return (
    <div style={{ padding: "0 16px" }}>
          ...
          {streak > 0 && (
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center",
              ...
              <div style={{ display:"flex", alignItems:"center", gap:4 }}>
                ...
                <span style={{ fontSize:20, fontWeight:700, color:"#D97706", fontFamily:DISP, lineHeight:1 }}>{streak}</span>
              </div>
              <div style={{ fontSize:10, fontWeight:600, color:"#92400E", fontFamily:DISP,
      ...
      {todaySeance ? (() => {
              ...
              return (
                <div style={{
                  ...
                  <div style={{ position: "relative", zIndex: 2, padding: "24px 24px 32px" }}>
                    <div style={{ color: "#9AA6FF", fontSize: 14, fontWeight: 700, letterSpacing: "1.5px", fontFamily: FONT }}>
                      SÉANCE DU JOUR
                    </div>
                    <div style={{ color: "#FFF", fontSize: 34, fontWeight: 700, letterSpacing: "-1px", margin: "12px 0 16px", lineHeight: 1, fontFamily: FONT }}>
                      {todaySeance.nom}
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 16, color: "#C3C8E6", fontSize: 16, fontWeight: 600, marginBottom: 20, fontFamily: FONT }}>
                      <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C3C8E6" strokeWidth="2">
                      ...
                      <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C3C8E6" strokeWidth="2" strokeLinecap="round">
              ...
              <>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:12 }}>
                  {(todaySeance.exercices || []).map((ex, idx) => {
                    ...
                    const thumbColors = {
                      push:["#EAF1FF",C.accent], pull:["#E8FAF1",C.green],
                    ...
                    return (
                      <div key={idx} style={{
                        ...
                        <div style={{ flex:1, minWidth:0 }}>
                          <div style={{
                            fontSize:14, fontWeight:700, color: isChecked ? "#9CA3AF" : C.text,
        ...
        <div style={{
          ...
          <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16 }}>
            <div style={{ display:"inline-flex",alignItems:"center",gap:8,padding:"8px 12px",borderRadius:999,background:"rgba(52,211,153,0.10)",border:"1px solid rgba(52,211,153,0.30)" }}>
          ...
          {/* Titre */}
          <div style={{ fontFamily:SERIF_F,fontSize:34,color:"#FFFFFF",lineHeight:1.08,letterSpacing:-1,marginBottom:12 }}>
            Aujourd'hui, on<br/><span style={{ color:"#60A5FA",fontStyle:"italic" }}>récupère.</span>
          </div>
          <div style={{ fontSize:13,color:"#C3C8E6",lineHeight:1.6,fontFamily:DISP,marginBottom:20 }}>
          ...
          {[
            ...
            <div key={i} onClick={g.tap||undefined} style={{
              ...
              <div style={{ flex:1, minWidth:0 }}>
                ...
                <div style={{ fontSize:11, color:"#9AA2C8", fontFamily:DISP, marginTop:1 }}>{g.s}</div>
              </div>
      ...
      {/* ── Records ─────────────────────────────────────────────── */}
      {prog && (() => {
        const REC_PALETTE = ["#60A5FA","#34D399","#FBBF24","#F87171","#B69DFF",C.accent];
        const trendOf = (hist) => {
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
            <div style={{ fontFamily:SERIF_F, fontSize:20, fontWeight:400, color:C.text, letterSpacing:-0.4 }}>
              Records & Objectifs
            </div>
            ...
            <div>
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:12 }}>
                {rmData.map((ex, i) => {
                  ...
                  const iconBg = [
                    ["#EAF1FF",C.accent],["#E8FAF1",C.green],
          ...
          <div onClick={()=>setShowSleepModal(false)} style={{
            ...
            <div onClick={e=>e.stopPropagation()} style={{
              ...
              <div style={{ padding:"20px 24px 0",display:"flex",alignItems:"center",justifyContent:"space-between" }}>
                <div>
                  <div style={{ fontFamily:F,fontSize:20,fontWeight:700,color:"${C.text}",letterSpacing:-0.4 }}>😴 Sommeil</div>
                ...
                <button onClick={()=>setShowSleepModal(false)} style={{
                  ...
                  border:"1px solid rgba(0,0,0,0.06)",color:C.mid,
              ...
              <div style={{ padding:"0 24px" }}>
                ...
                <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
                  ...
                  <button onClick={()=>saveSleepTarget(step(sleepTarget))} style={{
                    ...
                    color:"#9CB9F5",fontSize:20,cursor:"pointer",display:"grid",placeItems:"center",
                  }}>+</button>
                </div>
