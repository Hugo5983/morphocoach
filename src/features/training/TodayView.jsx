  ...
  return (
    <div style={{ padding: "0 16px" }}>
      ...
      {todaySeance ? (() => {
        ...
        return (
          <>
              {/* Hero card — mannequin MorphoCoach */}
            {(() => {
              const MANNEQUINS = {
              ...
              const getMannequin = () => {
                const combined = ((todaySeance.nom || '') + ' ' + (todaySeance.focus || '')).toLowerCase();
                if (combined.includes('dos') || combined.includes('back') || combined.includes('pull') || combined.includes('tirage'))
                  return MANNEQUINS.blue_back;
                if (combined.includes('jambe') || combined.includes('legs') || combined.includes('squat'))
                  return MANNEQUINS.purple;
                if (combined.includes('push') || combined.includes('pec') || combined.includes('poitrine') || combined.includes('force'))
                  return MANNEQUINS.red;
                return MANNEQUINS.blue_front;
              };
              const bg = '#060b1f';
              return (
                <div style={{
                  ...
                  {/* Mannequin */}
                  <img src={getMannequin()} alt="" aria-hidden="true" style={{
                  ...
                  {/* Fondu haut */}
                  <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '22%', zIndex: 1, pointerEvents: 'none',
                    background: `linear-gradient(to bottom, ${bg}8c 0%, transparent 100%)`,
                  }} />
                  {/* Haut gauche : eyebrow + nom */}
                  <div style={{ position: 'absolute', top: 14, left: 15, zIndex: 2, display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  <div style={{ position: 'absolute', bottom: 14, left: 15, zIndex: 2, display: 'flex', flexDirection: 'column', gap: 7 }}>
                    ...
                    {!todaySeance.complete && (
                      <button onClick={() => setFocusActive(true)} style={{
                        ...
                        padding: '8px 18px', color: '#fff', fontSize: 12, fontWeight: 800,
                        display: 'flex', alignItems: 'center', gap: 5,
                        cursor: 'pointer', fontFamily: DISP,
                      }}>
