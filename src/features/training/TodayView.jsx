    ...
    return (
      <div style={{minHeight:"100vh",background:"#0B0F1F"}}>
        <div style={{padding:"20px 16px",paddingBottom:80}}>
          ...
          <button onClick={()=>setNewExForm(null)} style={{width:"100%",padding:"12px",background:"#4D8BFF",border:"none",borderRadius:10,color:"#141A2E",fontSize:13,fontWeight:600,cursor:"pointer",fontFamily:"'Outfit','DM Sans',system-ui,sans-serif"}}>✓ Valider</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0B0F1F"}}>
      <div style={{padding:"20px 16px",paddingBottom:80}}>
        ...
        <button onClick={handleSave} style={{width:"100%",padding:"13px",background:"#4D8BFF",border:"none",borderRadius:12,color:"#141A2E",fontSize:14,fontWeight:600,cursor:"pointer",fontFamily:"'Outfit','DM Sans',system-ui,sans-serif",marginBottom:8}}>
          ✓ Créer la séance
        </button>
        <button onClick={onClose} style={{width:"100%",padding:"10px",background:"transparent",border:"0.5px solid rgba(190,180,255,0.07)",borderRadius:10,color:"rgba(245,241,232,0.50)",cursor:"pointer",fontSize:12,fontFamily:"'Inter',sans-serif"}}>Annuler</button>
      </div>
