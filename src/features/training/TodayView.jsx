              ...
              return (
                <div style={{
                  ...
                  <div style={{ position: "relative", zIndex: 2, padding: "22px 22px 0" }}>
                    ...
                    <div style={{ color: "#fff", fontSize: 38, fontWeight: 800, letterSpacing: "-1px", margin: "12px 0 14px", lineHeight: 1, fontFamily: FONT }}>
                      {todaySeance.nom}
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 16, color: "#c3c8e6", fontSize: 15.5, fontWeight: 600, marginBottom: 20, fontFamily: FONT }}>
