      ...
      <div style={{ position:"fixed", inset:0, zIndex:300,
        ...
        <div style={{ flexShrink:0,
          ...
          <button onClick={() => step>1 ? goStep(step-1) : onCancel?.()}
            style={{ width:42, height:42, borderRadius:16, border:`1px solid ${BD}`,
        ...
        <div style={{ flex:1, minHeight:0, overflowY:"auto", padding:"16px 20px 20px" }} className="mc-scroll">
          ...
          {step===1 && (
            <div className="mc-page">
              ...
              <h1 style={{ fontFamily:SF, fontSize:34, fontWeight:700, letterSpacing:"-.8px",
              ...
              {/* Nom */}
              <div style={{ fontSize:11, fontWeight:700, letterSpacing:"2px", color:DIM,
              ...
              <div style={{ display:"flex", alignItems:"center", gap:8,
                fontSize:11, fontWeight:700, letterSpacing:"2px", color:DIM,
          ...
          {step===2 && ad && s && (
            <div className="mc-page" key={"s2-"+ad}>
              ...
              {s.ex.length===0
                ? <div style={{borderRadius:20,padding:"20px 16px",background:"rgba(0,0,0,0.01)",border:`1px dashed ${BD}`}}>
          ...
          {step===3 && (
            <div className="mc-page">
              ...
              <h1 style={{ fontFamily:SF, fontSize:34, fontWeight:700, letterSpacing:"-.6px",
              ...
              <div style={{ background:S1, borderRadius:20, border:`1px solid ${BD}`,
                ...
                <div style={{ padding:"20px 20px 16px",
                  ...
                  <div style={{ fontSize:20, fontWeight:700, fontFamily:SF,
                    color:TEXT, letterSpacing:"-.3px", marginBottom:12 }}>
