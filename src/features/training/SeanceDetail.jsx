  ...
  return (
    <div style={{ padding: "0 16px" }}>
      ...
      <div style={{ paddingTop: 8, marginBottom: 16 }}>
        <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "2px", color: C.dim, textTransform: "uppercase", fontFamily: DISP, marginBottom: 4 }}>
      ...
      {todaySeance ? (() => {
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32, position: "relative" }}>
                <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "1.4px", color: "rgba(0,0,0,0.46)", background: "rgba(0,0,0,0.18)", padding: "8px 12px", borderRadius: 999, fontFamily: DISP }}>
                  SÉANCE DU JOUR
                </div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <div style={{ fontSize: 13, color: "rgba(0,0,0,0.42)", fontFamily: DISP, marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {/* Barre progression */}
                <div style={{ height: 4, background: "rgba(0,0,0,0.10)", borderRadius: 999, overflow: "hidden" }}>
        ...
        <div style={{
          ...
          {/* Titre */}
          <div style={{ fontFamily:SERIF_F,fontSize:34,color:"${C.text}",lineHeight:1.08,letterSpacing:-1,marginBottom:12 }}>
          ...
          {[
            ...
            <div key={i} style={{ display:"flex",alignItems:"center",gap:12,padding:"12px 0",borderTop:"1px solid rgba(0,0,0,0.04)" }}>
              <div style={{ width:42,height:42,borderRadius:12,background:g.bg,border:`1px solid ${g.bd}`,display:"grid",placeItems:"center",flexShrink:0,fontSize:20 }}>{g.ic}</div>
              <div style={{ flex:1,minWidth:0 }}>
      ...
      {prog && (() => {
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontFamily: SERIF_F, fontSize: 20, fontWeight: 400, color: "${C.text}", letterSpacing: -0.4 }}>Records & Objectifs</div>
          </div>
