      ...
      <div style={{paddingBottom:80}}>
        ...
        <div style={{padding:"0 15px"}}>
          <div style={{padding:"14px 16px",background:`${int.c}14`,border:`0.5px solid ${int.c}40`,borderRadius:12,marginBottom:14}}>
            ...
            <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:20,fontWeight:400,marginBottom:4}}>{jour.nom}</div>
            <div style={{fontSize:11,color:"rgba(245,241,232,0.50)"}}>{jour.focus} · {jour.duree || "45-60 min"} · {exercices.length} exercice{exercices.length!==1?"s":""}</div>
          </div>
          ...
          {exercices.map((ex, k) => {
            ...
            return (
              <div key={k} style={{background:"#141A2E",border:"0.5px solid rgba(190,180,255,0.07)",borderRadius:11,marginBottom:8,overflow:"hidden"}}>
                <div style={{padding:"11px 13px",borderLeft:`3px solid ${colour}`}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                    <div style={{flex:1}}>
                      <div style={{fontSize:12,fontWeight:600,color:"#F5F1E8",marginBottom:3}}>{ex.nom}</div>
          ...
          <button onClick={()=>setShowBiblio(true)} style={{width:"100%",padding:"12px",background:"transparent",border:"1px dashed #4D8BFF",borderRadius:10,color:"#4D8BFF",cursor:"pointer",fontSize:13,fontWeight:600,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",display:"flex",alignItems:"center",justifyContent:"center",gap:8,marginTop:4}}>
