    ...
    <div style={{paddingBottom:32}}>
          ...
          {subNav.map(s=>{
            ...
            return(
              <button key={s.id} onClick={()=>setProgView(s.id)} className="tap" style={{
                ...
                border:on?"1px solid rgba(59,130,246,0.25)":"1px solid transparent",
      ...
      {progView==="analyse" && !premium && (
        <div style={{padding:"4px 20px 0"}}>
          ...
          <div style={{position:"relative",borderRadius:28,overflow:"hidden",marginTop:20,padding:"24px 24px 24px",background:`radial-gradient(120% 60% at 70% 0%, rgba(255,171,93,0.25), transparent 60%), radial-gradient(80% 60% at 0% 100%, rgba(77,139,255,0.18), transparent 60%), linear-gradient(160deg, ${C.s2} 0%, ${C.s1} 100%)`,border:`1px solid ${C.bdHi}`,boxShadow:"0 24px 48px rgba(0,0,0,0.5), inset 0 1px 0 rgba(0,0,0,0.05)"}}>
