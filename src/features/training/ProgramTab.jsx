      ...
      {prog && cycleStart && (() => {
        ...
        return (
          <div style={{position:"relative",borderRadius:22,overflow:"hidden",marginBottom:14,padding:20,background:`linear-gradient(160deg, ${C.s2} 0%, ${C.s1} 100%)`,border:`1px solid ${C.bd}`,boxShadow:"inset 0 1px 0 rgba(255,255,255,0.03)"}}>
            ...
            <div style={{position:"relative"}}>
              <div style={{fontSize:9,fontWeight:700,color:C.gold,letterSpacing:2,textTransform:"uppercase",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}>Cycle en cours · {prog.titre}</div>
              <div style={{display:"flex",alignItems:"baseline",gap:6,marginTop:8}}>
                ...
                <span style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:18,color:C.mid,fontWeight:600}}>/ {totalW}</span>
                <span style={{fontSize:9,fontWeight:700,color:C.dim,letterSpacing:2,textTransform:"uppercase",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",marginLeft:4}}>sem.</span>
              </div>
                ...
                {Array.from({length:totalW}).map((_,i)=>{
                  ...
                  return(
                    <div key={i} style={{flex:1}}>
                      ...
                      <div style={{marginTop:6,fontSize:9,fontWeight:700,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",letterSpacing:0.3,color:(done||current)?C.mid:C.dim,textAlign:"center"}}>S{i+1}</div>
                    </div>
                  );
                })}
              </div>
              <div style={{marginTop:14,display:"flex",justifyContent:"space-between"}}>
                {[
                  ...
                  <div key={s.u} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:3}}>
                    ...
                    <span style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:13,fontWeight:700,color:C.text,letterSpacing:-0.2}}>{s.v}</span>
                    <span style={{fontSize:8,fontWeight:700,color:C.dim,letterSpacing:1.5,textTransform:"uppercase",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}>{s.u}</span>
                  </div>
                ))}
              </div>
            </div>
    ...
    <div style={{paddingBottom:16}}>
      ...
      <div style={{padding:"18px 20px 0",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:7}}>
          ...
          <span style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontWeight:700,fontSize:11,letterSpacing:0.5,color:C.text,textTransform:"uppercase"}}>Morpho<span style={{color:C.gold}}>·</span>Coach</span>
        </div>
        <button onClick={()=>props.setTab&&props.setTab("profile")} className="tap" style={{width:34,height:34,borderRadius:999,background:`linear-gradient(145deg, ${C.gold}, ${C.amberDk})`,border:"1px solid rgba(255,255,255,0.22)",color:"#1A1308",display:"grid",placeItems:"center",padding:0,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:13,fontWeight:800,cursor:"pointer",boxShadow:`0 4px 10px ${C.amberDk}55, inset 0 1px 0 rgba(255,255,255,0.4)`}}>
          ...
          {subNav.map(s=>{
            ...
            return(
              <button key={s.id} onClick={()=>setProgView(s.id)} className="tap" style={{
                ...
                fontSize:11.5,fontWeight:700,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",letterSpacing:0.2,
      ...
      {progView==="analyse" && !premium && (
        <div style={{padding:"4px 20px 0"}}>
          <div style={{fontSize:9,fontWeight:700,color:C.dim,letterSpacing:2,textTransform:"uppercase",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}>MorphoCoach</div>
          ...
          <div style={{position:"relative",borderRadius:26,overflow:"hidden",marginTop:20,padding:"26px 22px 24px",background:`radial-gradient(120% 60% at 70% 0%, rgba(255,171,93,0.22), transparent 60%), radial-gradient(80% 60% at 0% 100%, rgba(77,139,255,0.18), transparent 60%), linear-gradient(160deg, ${C.s2} 0%, ${C.s1} 100%)`,border:`1px solid ${C.bdHi}`,boxShadow:"0 24px 48px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.06)"}}>
            ...
            <div style={{display:"inline-flex",alignItems:"center",gap:5,padding:"5px 10px",borderRadius:999,background:`${C.gold}20`,border:`1px solid ${C.gold}40`,color:C.goldL,fontSize:10,fontWeight:800,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",letterSpacing:1}}>♛ PRO</div>
            ...
            <div style={{marginTop:20,display:"flex",flexDirection:"column",gap:12}}>
              {[
                ...
                <div key={f.t} style={{display:"flex",alignItems:"flex-start",gap:12}}>
                  ...
                  <div>
                    <div style={{fontSize:13,fontWeight:700,color:C.text,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",letterSpacing:-0.1}}>{f.t}</div>
            ...
            <div style={{marginTop:20,padding:"14px 16px",borderRadius:16,background:"rgba(11,15,31,0.5)",border:`1px solid ${C.bd}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
                <div style={{fontSize:9,fontWeight:700,color:C.dim,letterSpacing:1.5,textTransform:"uppercase",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}>Cycle 6 semaines</div>
              ...
              <div style={{padding:"5px 10px",borderRadius:999,background:`${C.mint}18`,border:`1px solid ${C.mint}40`,color:C.mint,fontSize:10,fontWeight:800,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",letterSpacing:0.5}}>ÉCONOMIE 40%</div>
            </div>
            <button className="tap" onClick={()=>setPaywall(true)} style={{marginTop:16,width:"100%",padding:"16px",borderRadius:16,background:`linear-gradient(135deg, ${C.gold}, ${C.amberDk})`,border:"1px solid rgba(255,255,255,0.22)",color:"#1A1308",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:15,fontWeight:700,letterSpacing:0.2,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:`0 10px 24px ${C.amberDk}55, inset 0 1px 0 rgba(255,255,255,0.45)`}}>⚡ Commencer maintenant</button>
            <button onClick={()=>setProgView("today")} style={{marginTop:10,width:"100%",padding:"6px",background:"transparent",border:"none",color:C.mid,fontSize:12,fontWeight:600,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",cursor:"pointer"}}>Continuer en gratuit</button>
          </div>
        </div>
      )}
    </div>
