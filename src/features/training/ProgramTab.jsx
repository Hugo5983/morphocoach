  ...
  return(
    <div style={{paddingBottom:16}}>
      ...
      <div style={{padding:"16px 20px 0"}}>
        <div style={{display:"flex",gap:8,padding:4,borderRadius:16,background:C.s2,border:`1px solid rgba(0,0,0,0.07)`}}>
          {subNav.map(s=>{
            ...
            return(
              <button key={s.id} onClick={()=>setProgView(s.id)} className="tap" style={{
                ...
                fontSize:11,fontWeight:700,fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",letterSpacing:0.2,
      ...
      {progView==="analyse" && !premium && (
        <div style={{padding:"4px 20px 0"}}>
          <div style={{fontSize:10,fontWeight:700,color:C.dim,letterSpacing:2,textTransform:"uppercase",fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>MorphoCoach</div>
          <div style={{fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",fontSize:34,fontWeight:700,letterSpacing:-1.2,color:C.text,lineHeight:1.05,marginTop:8}}>Passe en <span style={{fontStyle:"italic",color:C.goldL}}>Pro</span></div>
          ...
          <div style={{position:"relative",borderRadius:28,overflow:"hidden",marginTop:20,padding:"24px 24px 24px",background:`radial-gradient(120% 60% at 70% 0%, rgba(255,171,93,0.22), transparent 60%), radial-gradient(80% 60% at 0% 100%, rgba(77,139,255,0.18), transparent 60%), linear-gradient(160deg, ${C.s2} 0%, ${C.s1} 100%)`,border:`1px solid ${C.bdHi}`,boxShadow:"0 24px 48px rgba(0,0,0,0.5), inset 0 1px 0 rgba(0,0,0,0.05)"}}>
            ...
            <div style={{display:"inline-flex",alignItems:"center",gap:4,padding:"4px 12px",borderRadius:999,background:`${C.gold}20`,border:`1px solid ${C.gold}40`,color:C.goldL,fontSize:10,fontWeight:700,fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",letterSpacing:1}}>♛ PRO</div>
            <div style={{fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",fontSize:34,fontWeight:700,letterSpacing:-1.3,color:C.text,lineHeight:1,marginTop:16}}>L'expérience<br/><span style={{fontStyle:"italic",color:C.goldL}}>complète.</span></div>
            <div style={{marginTop:20,display:"flex",flexDirection:"column",gap:12}}>
              {[
                ...
                <div key={f.t} style={{display:"flex",alignItems:"flex-start",gap:12}}>
                  <div style={{width:32,height:32,borderRadius:12,flexShrink:0,background:`${C.gold}18`,border:`1px solid ${C.gold}35`,color:C.goldL,display:"grid",placeItems:"center",fontSize:14}}>{f.i}</div>
                  <div>
            ...
            <div style={{marginTop:20,padding:"16px 16px",borderRadius:16,background:"rgba(11,15,31,0.5)",border:`1px solid ${C.bd}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
                <div style={{fontSize:10,fontWeight:700,color:C.dim,letterSpacing:1.5,textTransform:"uppercase",fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif"}}>Cycle 6 semaines</div>
              ...
              <div style={{padding:"4px 12px",borderRadius:999,background:`${C.mint}18`,border:`1px solid ${C.mint}40`,color:C.mint,fontSize:10,fontWeight:700,fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",letterSpacing:0.5}}>ÉCONOMIE 40%</div>
            </div>
            <button className="tap" onClick={()=>setPaywall(true)} style={{marginTop:16,width:"100%",padding:"16px",borderRadius:16,background:`linear-gradient(135deg, ${C.gold}, ${C.amberDk})`,border:"1px solid rgba(0,0,0,0.11)",color:"#1A1308",fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",fontSize:14,fontWeight:700,letterSpacing:0.2,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:8,boxShadow:`0 10px 24px ${C.amberDk}55, inset 0 1px 0 rgba(0,0,0,0.23)`}}>⚡ Commencer maintenant</button>
            <button onClick={()=>setProgView("today")} style={{marginTop:12,width:"100%",padding:"8px",background:"transparent",border:"none",color:C.mid,fontSize:13,fontWeight:600,fontFamily:"'General Sans',system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif",cursor:"pointer"}}>Continuer en gratuit</button>
          </div>
        </div>
      )}
    </div>
