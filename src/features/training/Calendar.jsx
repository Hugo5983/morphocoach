        ...
        <div style={{padding:"0 16px"}}>
          ...
          {step === 1 && ergo && (
            <div>
              ...
              <div style={{background:"#141A2E",border:"0.5px solid rgba(190,180,255,0.07)",borderRadius:12,padding:"14px 16px",marginBottom:10}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  ...
                  <div style={{flex:1,textAlign:"center"}}>
                    <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:32,fontWeight:300,color:"#F5F1E8",lineHeight:1}}>{duree}</div>
              ...
              <div style={{background:"#141A2E",border:`1px solid ${kcalFinal>0?"rgba(59,130,246,0.2)":"rgba(190,180,255,0.07)"}`,borderRadius:12,padding:"14px 16px",marginBottom:16}}>
                ...
                {editKcal ? (
                  <div style={{display:"flex",alignItems:"center",gap:8}}>
                    <input value={kcalManuel} onChange={e=>setKcalManuel(e.target.value)} style={{flex:1,padding:"10px 12px",background:"#1C2440",border:"0.5px solid #4D8BFF",borderRadius:9,fontSize:16,fontWeight:500,color:"#F5F1E8",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}/>
                    <span style={{fontSize:12,color:"rgba(245,241,232,0.50)"}}>kcal</span>
                  </div>
                ) : (
                  <div style={{display:"flex",alignItems:"baseline",gap:6}}>
                    <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:36,fontWeight:300,color:kcalAuto>0?"#4D8BFF":"rgba(245,241,232,0.32)",lineHeight:1}}>{kcalAuto>0?kcalAuto:"—"}</div>
              ...
              <button onClick={handleSave} style={{width:"100%",padding:"14px",background:"#4D8BFF",border:"none",borderRadius:12,color:"#141A2E",fontSize:14,fontWeight:600,cursor:"pointer",fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",marginBottom:8}}>
          ...
          {sport && (
            <div>
              ...
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"12px 14px",background:`${sport.color}10`,border:`0.5px solid ${sport.color}30`,borderRadius:12,marginBottom:12}}>
                ...
                <div>
                  <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:16,fontWeight:400,color:"#F5F1E8"}}>{sport.l}</div>
              ...
              <div style={{background:"#141A2E",border:`1px solid ${kcalAuto>0?"rgba(59,130,246,0.2)":"rgba(190,180,255,0.07)"}`,borderRadius:12,padding:"14px 16px",marginBottom:16}}>
                ...
                {editKcal ? (
                  ...
                  <div>
                    <div style={{display:"flex",alignItems:"baseline",gap:6}}>
                      <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:36,fontWeight:300,color:"#4D8BFF",lineHeight:1}}>{kcalAuto}</div>
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0B0F1F"}}>
      <div style={{padding:"20px 16px",paddingBottom:80}}>
        ...
        <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:20,fontWeight:300,color:"#F5F1E8",marginBottom:4}}>{ex.nom}</div>
        ...
        {dbEx && (
          <>
            ...
            {onOpenGuide && (
              <button onClick={()=>onOpenGuide(dbEx,ex)} style={{width:"100%",padding:"12px",background:"rgba(59,130,246,0.06)",border:"0.5px solid rgba(59,130,246,0.25)",borderRadius:11,color:"#4D8BFF",cursor:"pointer",fontSize:13,fontWeight:600,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",marginTop:4}}>
    ...
    return (
      <div style={{padding:"0 15px"}}>
        ...
        <div style={{padding:"12px 14px",background:`${int.c}14`,border:`0.5px solid ${int.c}40`,borderRadius:12,marginBottom:4}}>
          ...
          <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:18,fontWeight:400,marginBottom:2}}>{jour.nom}</div>
        ...
        <Box style={{background:"rgba(59,130,246,0.06)",borderColor:C.goldB}}>
          <Row style={{justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
            <div>
              ...
              <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:14,fontWeight:500}}>{prog.titre}</div>
            ...
            {WEEK_INTENSITY.map((k,w) => {
              ...
              return (
                <div key={w} onClick={() => setCurrentWeek(w)} style={{padding:"9px 4px",background:isSelected?`${int.c}20`:isDone?"rgba(34,197,94,0.1)":C.s2,border:`1px solid ${isSelected?int.c:isDone?"rgba(56,199,117,.25)":C.s3}`,borderRadius:9,textAlign:"center",cursor:"pointer",transition:"all .12s"}}>
                  <div style={{fontSize:9,color:isSelected?int.c:isDone?C.green:C.dim,fontWeight:700,fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif"}}>S{w+1}</div>
