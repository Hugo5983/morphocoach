...
// ─── PROFILE ──────────────────────────────────────────────────────────────
 ...
 <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:20,fontWeight:300,color:"#F5F1E8",marginBottom:3}}>{profil.prenom||"Mon profil"}</div>
 ...
 <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:24,letterSpacing:2,color:C.gold,textAlign:"center",marginBottom:4}}>PASSER À PREMIUM</div>
 ...
 <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:28,color:C.gold,letterSpacing:-0.5,fontWeight:300}}>19.99€<span style={{fontSize:12,color:"rgba(245,241,232,0.50)",fontFamily:"'Inter',sans-serif",fontWeight:400}}> /cycle</span></div>
 </div>
 ...
 <div><div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:16,color:C.gold,letterSpacing:-0.5,fontWeight:300}}>MEMBRE PREMIUM</div><div style={{fontSize:10,color:"rgba(245,241,232,0.50)"}}>Accès complet activé</div></div>
 </Box>}
 <Box>
 ...
 <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:34,color:"#4D8BFF",fontWeight:300,letterSpacing:-1,lineHeight:1}}>{calObj}</div>
 ...
 <div style={{fontFamily:"'Space Grotesk','Inter',system-ui,sans-serif",fontSize:20,color:m.c,fontWeight:300}}>{m.v}<span style={{fontSize:9}}>g</span></div>
