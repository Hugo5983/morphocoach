...
export default function Profile(props) {
  ...
  const imcColor = imcVal < 18.5 ? DARK.accent : imcVal < 25 ? "#34D399" : imcVal < 30 ? "#FB923C" : "#F87171";
  ...
  return (
    <div className="anim" style={{
      ...
      background: `radial-gradient(800px 400px at 70% -10%, rgba(59,130,246,0.12), transparent 60%), ${C.bg}`,
    }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {(premium || premiumNutrition) && (
              <span style={{
                ...
                boxShadow: "0 4px 12px -3px rgba(59,130,246,0.85)",
                fontFamily: FONT,
              }}>
                PRO
              </span>
        ...
        <div key="compo">
          ...
          <Glass pad={0} style={{ animation: "rise .4s .14s both" }}>
            <div style={{ padding: "16px 20px" }}>
              ...
              {imc && (
                <div style={{ height: 6, borderRadius: 999, background: "linear-gradient(90deg,#34D399,#FBBF24,#F87171)", position: "relative" }}>
                  <div style={{ position: "absolute", top: -3, left: `${imcPct}%`, width: 12, height: 12, borderRadius: "50%", background: "#FFF", border: "2px solid #CBD5E1", boxShadow: C.shadow, transform: "translateX(-50%)" }}/>
                </div>
              )}
