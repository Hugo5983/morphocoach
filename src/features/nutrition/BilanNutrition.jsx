...
export default function BilanNutrition({
  ...
  const renderDashboard = () => (
    <>
      ...
      {/* Régularité */}
      <div style={{ margin:"0 16px 14px" }}>
        <SectionHeader title="Régularité du suivi" hint={`${bilan.totalDays} derniers jours`}/>
  ...
  // ─── RENDER ────────────────────────────────────────────────────────────
  return (
    <div ref={scrollRef} style={{ minHeight:"100vh", maxHeight:"100vh", overflowY:"auto", WebkitOverflowScrolling:"touch", background:BG, fontFamily:FONT,
      paddingBottom:30 }}>
      {/* Header retour */}
