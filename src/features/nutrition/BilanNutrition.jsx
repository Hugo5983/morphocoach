          ...
          <div style={{ flex:1 }}>
            {bilan.isPartial ? (
              <div style={{ display:"inline-flex",alignItems:"center",gap:8,fontSize:11,
                ...
                background:"rgba(255,255,255,0.16)",padding:"4px 12px",borderRadius:8,fontFamily:FONT }}>
            ...
            <div style={{ fontSize:11,opacity:.72,marginTop:8,lineHeight:1.55,fontFamily:FONT }}>
            ...
            <div style={{ flex:1 }}>
              <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center" }}>
                <div style={{ display:"flex",alignItems:"baseline",gap:4 }}>
                  <span style={{ fontSize:34,fontWeight:700,color:TEXT,fontFamily:SERIF,letterSpacing:-.5,...NUM }}>
              ...
              <div style={{ height:9,borderRadius:8,background:"rgba(16,185,129,0.10)",
    ...
    <>
      {!hasFood && (
        <div style={{ margin:"0 16px 16px",background:S1,border:`1px solid ${BD}`,
          ...
          <div style={{ width:46,height:46,borderRadius:16,margin:"0 auto 12px",
      ...
      {hasFood && (<>
        <div style={{ margin:"0 16px 16px",background:S1,border:`1px solid ${BD}`,
          ...
          <div style={{ position:"absolute",top:-50,right:-50,width:180,height:180,
            ...
            pointerEvents:"none" }}/>
          <div style={{ fontSize:10,fontWeight:700,letterSpacing:"1.6px",
