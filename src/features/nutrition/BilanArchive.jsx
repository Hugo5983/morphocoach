        ...
        <>
          ...
          <div style={{ margin:"0 16px", padding:"20px 12px 12px",
            ...
            <div style={{ display:"flex", justifyContent:"space-between",
              paddingTop:16, marginTop:8, borderTop:"1px solid rgba(0,0,0,0.04)" }}>
    ...
    <button onClick={onClick} style={{
      ...
      {current ? (
        <span style={{ padding:"2px 8px", background:"rgba(59,130,246,0.15)",
          ...
          fontSize:10, fontWeight:700, color:C.blueLt, letterSpacing:"0.5px", fontFamily:FONT }}>
          EN COURS
        </span>
      ) : (
...
function Stat({ icon, letter, color, label, highlight }) {
  return (
    <div style={{ textAlign:"center" }}>
      ...
      <div style={{ fontSize:10, color:DIM, marginTop:2, letterSpacing:"0.4px",
