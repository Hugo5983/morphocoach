      ...
      <div style={{position:'relative'}}>
        ...
        <div style={{padding:'20px 16px 0'}}>
          ...
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',
            ...
            <button className="tap-icon" onClick={()=>setDayOff(d=>d-1)} style={{
              width:32,height:32,borderRadius:12,background:'rgba(0,0,0,0.03)',
          ...
          <div style={{position:'relative',display:'flex',padding:4,borderRadius:12,
            background:C.s2,border:'1px solid rgba(0,0,0,0.07)',marginBottom:2}}>
                ...
                <div style={{marginBottom:12}}>
                  <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
                    ...
                    <div style={{display:'flex',gap:4}}>
                      ...
                      <button onClick={()=>setFruitsV(f=>({...f,fruits:Math.min(10,f.fruits+1)}))} style={{width:24,height:24,borderRadius:8,background:'rgba(245,158,11,0.12)',border:'1px solid rgba(245,158,11,0.30)',color:'#F59E0B',cursor:'pointer',fontSize:14,display:'grid',placeItems:'center'}}>+</button>
                    </div>
                  </div>
                  <div style={{display:'flex',gap:4}}>
                ...
                <div>
                  <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
                    ...
                    <div style={{display:'flex',gap:4}}>
                      ...
                      <button onClick={()=>setFruitsV(f=>({...f,legumes:Math.min(10,f.legumes+1)}))} style={{width:24,height:24,borderRadius:8,background:'rgba(52,211,153,0.12)',border:'1px solid rgba(52,211,153,0.30)',color:'#34D399',cursor:'pointer',fontSize:14,display:'grid',placeItems:'center'}}>+</button>
                    </div>
                  </div>
                  <div style={{display:'flex',gap:4}}>
                    {Array.from({length:5}).map((_,i)=>{
        ...
        {nView==="scanner"&&(
          <div style={{padding:'16px 16px 0'}}>
            ...
            <div style={{background:C.s1, border:`1px solid ${C.bd}`, borderRadius:16, boxShadow:'0 1px 3px rgba(0,0,0,0.25), inset 0 1px 0 rgba(0,0,0,0.03)', padding:20}}>
              <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:16}}>
                ...
                <button className="tap" onClick={()=>setShowCamera(true)} style={{
                  padding:'8px 16px',background:'rgba(59,130,246,0.10)',
              ...
              {scanRes?.error&&(
                <div style={{padding:'12px 12px',background:'rgba(248,113,113,0.10)',
