      ...
      <div style={{ position:"relative", flex:1, overflow:"hidden" }}>
        ...
        {status === "scanning" && (
          <div style={{
            ...
            <div style={{ position:"absolute", inset:0, background:"rgba(15,25,35,0.5)" }}/>
            {/* Rectangle viseur */}
            <div style={{
              position:"relative",
              ...
              {/* Coins */}
              {[
                { top:0,left:0,borderTop:"3px solid #3B82F6",borderLeft:"3px solid #3B82F6",borderRadius:"12px 0 0 0" },
                { top:0,right:0,borderTop:"3px solid #3B82F6",borderRight:"3px solid #3B82F6",borderRadius:"0 12px 0 0" },
                { bottom:0,left:0,borderBottom:"3px solid #3B82F6",borderLeft:"3px solid #3B82F6",borderRadius:"0 0 0 12px" },
                { bottom:0,right:0,borderBottom:"3px solid #3B82F6",borderRight:"3px solid #3B82F6",borderRadius:"0 0 12px 0" },
              ].map((s,i) => (
