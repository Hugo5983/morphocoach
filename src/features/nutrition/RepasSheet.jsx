            ...
            {items.map((item, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12,
                ...
                <button onClick={() => onRemove(i)} style={{ width: 32, height: 32,
                  ...
                  background: "rgba(248,113,113,0.05)", display: "grid", placeItems: "center",
        ...
        {!search && (
          <>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
              ...
              <button
                ...
                style={{ padding: "12px 20px",
                  ...
                  fontSize: 13, fontWeight: 700, fontFamily: F, cursor: "pointer",
                  transition: "all .2s",
                  boxShadow: manualCode.length >= 8 ? "0 4px 14px rgba(59,130,246,0.25)" : "none" }}>
                OK
              </button>
            </div>
            ...
            {scanRes && !scanRes.error && (
              <div className="rs-fade" style={{ padding: 16, background: "rgba(52,211,153,0.05)",
                border: "1px solid rgba(52,211,153,0.25)", borderRadius: 16, marginBottom: 16 }}>
            ...
            {scanRes?.error && (
              <div style={{ padding: "12px 12px", background: "rgba(248,113,113,0.08)",
            ...
            <div onClick={e => e.stopPropagation()} className="rs-pop" style={{
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20, marginBottom: 16 }}>
                ...
                <button onClick={() => setAmount(a => Math.round((a + step) * 10) / 10)}
                  style={{ width: 48, height: 48, borderRadius: 16, cursor: "pointer",
                    background: "linear-gradient(145deg,#3B82F6,#2563EB)", border: "1px solid rgba(37,99,235,0.5)",
                    color: "#FFF", fontSize: 26, fontWeight: 700, boxShadow: "0 4px 12px rgba(59,130,246,0.35)",
                    display: "grid", placeItems: "center", lineHeight: 1 }}>+</button>
              </div>
                  ...
                  return (
                    <button key={p} onClick={() => setAmount(p)}
                      style={{ flex: 1, padding: "8px 0", borderRadius: 12, cursor: "pointer",
                        ...
                        border: `1px solid ${on ? "rgba(59,130,246,0.35)" : BD}`,
              ...
              <button onClick={confirmQty} style={{ width: "100%", padding: "16px", borderRadius: 16,
                ...
                boxShadow: "0 8px 22px -8px rgba(59,130,246,0.85)" }}>
