...
import { C, FONT, NUM, SERIF } from "../../../data/constants.js";
...
export function MacroRow({ label, color, value, goal, pct, partial }) {
  ...
  const COLORS = {
    Protéines: { bg:"rgba(96,165,250,0.12)",  fg:"#60A5FA", bd:"rgba(96,165,250,0.25)",  fillFrom:"#60A5FA", fillTo:C.accent },
  ...
  return (
    <div style={{ display:"flex", alignItems:"center", gap:12, padding:"12px 0",
      ...
      <div style={{ width:38, height:38, borderRadius:12, display:"grid",
      ...
      <div style={{ flex:1, minWidth:0 }}>
        ...
        <div style={{ height:5, background:"rgba(0,0,0,0.04)", borderRadius:999, overflow:"hidden", marginBottom:4 }}>
        ...
        <div style={{ fontSize:11, color:"${C.mid}", fontFamily:FONT }}>
          <span style={{ display:"inline-block", padding:"2px 8px", borderRadius:4,
            fontSize:10, fontWeight:700, letterSpacing:"0.5px", marginRight:4,
...
export function CritRow({ crit }) {
  ...
  return (
    <div style={{ padding:"16px 0", borderBottom:"1px solid rgba(0,0,0,0.04)",
