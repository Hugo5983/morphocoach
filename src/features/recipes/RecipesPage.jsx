    ...
    <div className="anim" style={{ padding:"0 16px 20px" }}>
      ...
      <div style={{ paddingTop:20, paddingBottom:16,
        ...
        <button onClick={() => setShowFavs(v => !v)}
          ...
          style={{ height:38, padding:"0 16px", borderRadius:12,
        ...
        <div style={{ position:"relative", flexShrink:0 }}>
          <button onClick={() => setSortOpen(v => !v)}
            ...
            style={{ width:40, height:40,
              ...
              border:`1px solid ${sortBy!=="default" ? C.accent : "rgba(0,0,0,0.06)"}`,
          ...
          {sortOpen && (
            <>
              ...
              <div style={{ position:"absolute", top:46, right:0, zIndex:41,
                ...
                boxShadow:"0 10px 30px rgba(15,25,35,0.14)", padding:8, width:178 }}>
        ...
        {FILTRES.map(f => {
          ...
          return (
            <button key={f.id} onClick={() => setFiltre(f.id)} className="tap" style={{
              ...
              background: on ? C.accent : "rgba(0,0,0,0.04)",
              border:`1px solid ${on ? C.accent : "rgba(0,0,0,0.06)"}`,
              color: on ? "#FFF" : C.mid,
