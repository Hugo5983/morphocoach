...
export default function App() {
  ...
  const [premium, setPremium] = useStorage("premium", false);           // Coach PRO (programme IA)
  const [paywall, setPaywall] = useState(false);
  const [premiumNutrition, setPremiumNutrition] = useStorage("premiumNutrition", false); // Nutrition PRO
