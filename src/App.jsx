...
export default function App(){
 ...
 {showOnboarding&&<Onboarding profil={profil} setProfil={setProfil} setOnboardingDone={setOnboardingDone} loadIA={loadIA} setLoadIA={setLoadIA} loadMsg={loadMsg} setLoadMsg={setLoadMsg} cycles={cycles} setCycles={setCycles} setCycleStart={setCycleStart} setProg={setProg} photos={photos} setPhotos={setPhotos} readFile={readFile} corrigerFaibles={corrigerFaibles} setCorrigerFaibles={setCorrigerFaibles} push={push} C={C} INT={INT} EX={EX} />}
 ...
 {tab==="program"&&<ProgramTab prog={prog} premium={premium} setPaywall={setPaywall} checkedEx={checkedEx} seance={seance} setSeance={openSeance} setChrono={setChrono} setChronoSec={setChronoSec} exDetails={exDetails} setExDetails={setExDetails} exEdit={exEdit} setExEdit={setExEdit} setProg={setProg} cycleStart={cycleStart} setCycleStart={setCycleStart} setCalSess={setCalSess} calSess={calSess} profil={profil} cycles={cycles} setCycles={setCycles} setTab={setTab} EX={EX} loadIA={loadIA} setLoadIA={setLoadIA} loadMsg={loadMsg} setLoadMsg={setLoadMsg} photos={photos} setPhotos={setPhotos} readFile={readFile} corrigerFaibles={corrigerFaibles} setCorrigerFaibles={setCorrigerFaibles} C={C} INT={INT} push={push} jR={jR} semC={semC} />}
