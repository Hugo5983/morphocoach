...
import Nutrition from "./features/nutrition/NutritionPage.jsx";
import Profile from "./features/profile/ProfilePage.jsx";
import ProgramTab from "./features/training/ProgramTab.jsx";
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Inter',sans-serif", color: C.text }}>
      ...
      {showOnboarding && <Onboarding {...onboardingProps} />}

      <main style={{ maxWidth: 500, margin: "0 auto", paddingBottom: 72 }}>
