...
const CARD_VARIANTS = {
  ...
  success: { background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.18)" },
  danger:  { background: "rgba(239,68,68,0.05)",  border: "1px solid rgba(239,68,68,0.18)" },
...
export const Btn = ({ children, onClick, disabled, v = "fill", sm, style }) => {
  const variants = {
    fill:  { bg: C.accent, color: "#FFFFFF", border: "none", shadow: "0 2px 8px rgba(59,130,246,0.25)" },
    out:   { bg: "transparent", color: C.accent, border: `1px solid rgba(59,130,246,0.35)`, shadow: "none" },
    ghost: { bg: C.s2, color: C.mid, border: `1px solid ${C.bd}`, shadow: "none" },
    danger:{ bg: "rgba(239,68,68,0.08)", color: C.red, border: "1px solid rgba(239,68,68,0.25)", shadow: "none" },
  };
