...
//
// ─── NOUVEAU · IDuo — jeu « Noir & Bleu plein » ──────────────────────────────
// Remplace les emoji retirés. Contour encre 1.5, intérieur #3C5BFF plein,
// détails intérieurs blancs 1.15, détails extérieurs encre 1.15.
//
// Usage :
//   import { IDuo } from "../../components/ui/Icon.jsx";
//   <IDuo name="bowl" />                       // 24px, contour #101318
//   <IDuo name="coffee" size={32} />
//   <IDuo name="streak" onDark />              // surfaces sombres : contour #F6F7F9
//
// Noms disponibles (33) :
//   Repas      : coffee bowl cloche apple mealprep
//   Nutrition  : protein carbs fat fiber water fruit fish egg calories
//   Activité   : run gym cardio steps timer hiit
//   Bien-être  : sleep energy breath recovery hydration
//   Coach      : coachDuo goal progress streak trophyDuo badge plan calendarDuo
...
// ═════════════════════════════════════════════════════════════════════════════
// IDuo — jeu « Noir & Bleu plein » (remplacement des emoji)
// Couches : fl intérieur bleu plein · s contour encre 1.5 ·
//           sx détails extérieurs encre 1.15 · sw détails intérieurs blancs 1.15 ·
//           dw points/pleins blancs
// ═════════════════════════════════════════════════════════════════════════════
...
const DUO = {
  ...
  /* ─────────── REPAS ─────────── */
  coffee:{
    fl:'<path d="M5.8 9.3h9.4v4.9a4.1 4.1 0 0 1-4.1 4.1h-1.2a4.1 4.1 0 0 1-4.1-4.1V9.3Z"/>',
  ...
  bowl:{
    fl:'<path d="M4.5 12.5h15a7.5 7.5 0 0 1-15 0Z"/>',
  ...
  cloche:{
    fl:'<path d="M4.5 15a7.5 7.5 0 0 1 15 0Z"/>',
  ...
  apple:{
    fl:'<path d="M12 7.4c-1.1-1.4-2.8-1.9-4.4-1.3-2.3.9-3.4 3.3-2.8 5.9.6 2.9 2.6 6 4.8 7 .8.4 1.5.3 2.4-.1.9.4 1.6.5 2.4.1 2.2-1 4.2-4.1 4.8-7 .6-2.6-.5-5-2.8-5.9-1.6-.6-3.3-.1-4.4 1.3Z"/><path d="M13.1 5.6c.4-1.7 1.6-2.7 3.4-2.9-.1 1.8-1.3 2.9-3.4 2.9Z"/>',
  ...
  mealprep:{
    fl:'<rect x="4.5" y="8.6" width="15" height="10.9" rx="2.2"/>',
  ...
  carbs:{
    fl:'<path d="M12 17.3c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Zm0-3.7c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Zm0-3.7c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Z"/><path d="M12 6.5c-.8-.9-1.1-2-1-3.3 1.3.3 2.1 1.3 2.1 2.6 0 .3-.3.5-1.1.7Z"/>',
    s:'<path d="M12 21V6.9"/>',
    sx:'<path d="M12 17.3c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Zm0-3.7c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Zm0-3.7c-2-.2-3.4-1-4-2.8 2-.2 3.4.6 4 2.8Zm0 0c2-.2 3.4-1 4-2.8-2-.2-3.4.6-4 2.8Z"/><path d="M12 6.5c-.8-.9-1.1-2-1-3.3 1.3.3 2.1 1.3 2.1 2.6 0 .3-.3.5-1.1.7Z"/>'},
  fat:{
    fl:'<path d="M12 4c3.2 0 5.5 3.5 5.5 8 0 4-2.4 7.5-5.5 7.5S6.5 16 6.5 12c0-4.5 2.3-8 5.5-8Z"/>',
  ...
  fiber:{
    fl:'<path d="M5 19c0-8 5-13.5 14-14 .4 8.6-4.6 14-11.5 14H5Z"/>',
  ...
  water:{
    fl:'<path d="M7 9.4l.8 9.4a2.1 2.1 0 0 0 2.1 1.9h4.4a2.1 2.1 0 0 0 2.1-1.9l.8-9.4c-1.7.8-8.5.8-10.2 0Z"/>',
  ...
  fruit:{
    fl:'<circle cx="12" cy="13.2" r="6.8"/><path d="M12.2 6.4c.1-1.9 1.3-3 3.2-3.2-.1 1.9-1.3 3-3.2 3.2Z"/>',
  ...
  fish:{
    fl:'<path d="M6.2 12c1.9-2.9 4.7-4.6 7.6-4.6 2.6 0 4.9 1.3 6.4 3.5.4.6.4 1.6 0 2.2-1.5 2.2-3.8 3.5-6.4 3.5-2.9 0-5.7-1.7-7.6-4.6Z"/><path d="M6.2 12 3.4 9.3v5.4L6.2 12Z"/>',
  ...
  egg:{
    fl:'<path d="M12 3.6c3.1 0 5.8 4.3 5.8 8.6a5.8 5.8 0 0 1-11.6 0c0-4.3 2.7-8.6 5.8-8.6Z"/>',
  ...
  calories:{
    fl:'<path d="M6.6 16a5.4 5.4 0 1 1 10.8 0Z"/>',
  ...
  gym:{
    fl:'<rect x="6" y="7" width="3.4" height="10" rx="1.2"/><rect x="14.6" y="7" width="3.4" height="10" rx="1.2"/><rect x="2.6" y="9.2" width="3.4" height="5.6" rx="1.1"/><rect x="18" y="9.2" width="3.4" height="5.6" rx="1.1"/>',
  ...
  cardio:{
    fl:'<path d="M12 19.5c-4.5-3.2-8-6-8-9.6C4 7 6 5.2 8.4 5.2c1.5 0 2.8.7 3.6 2 .8-1.3 2.1-2 3.6-2C18 5.2 20 7 20 9.9c0 3.6-3.5 6.4-8 9.6Z"/>',
  ...
  steps:{
    fl:'<ellipse cx="8" cy="8.6" rx="2.2" ry="3.1"/><ellipse cx="16" cy="12.6" rx="2.2" ry="3.1"/><ellipse cx="8" cy="14.7" rx="1.5" ry="1.9"/><ellipse cx="16" cy="18.7" rx="1.5" ry="1.9"/><circle cx="6.5" cy="4.6" r=".5"/><circle cx="8" cy="4.1" r=".55"/><circle cx="9.5" cy="4.6" r=".5"/><circle cx="14.5" cy="8.6" r=".5"/><circle cx="16" cy="8.1" r=".55"/><circle cx="17.5" cy="8.6" r=".5"/>',
  ...
  timer:{
    fl:'<path d="M12 13.2V5.9a7.3 7.3 0 0 1 6.7 4.4L12 13.2Z"/>',
  ...
  hiit:{
    fl:'<path d="M13 9.5l-3.1 4.2h2.1l-.9 3.6 3.1-4.2h-2.1l.9-3.6Z"/>',
    s:'<circle cx="12" cy="13.2" r="7.3"/><path d="M10 3h4M12 3v2.3"/>',
    sx:'<path d="M13 9.5l-3.1 4.2h2.1l-.9 3.6 3.1-4.2h-2.1l.9-3.6Z"/>'},

  /* ─────────── BIEN-ÊTRE ─────────── */
  sleep:{
    fl:'<path d="M20 13.7A8.1 8.1 0 0 1 10.3 4 8.1 8.1 0 1 0 20 13.7Z"/>',
  ...
  energy:{
    fl:'<path d="M13 2.5 4 14.5h6l-1 8 9-12h-6l1-8Z"/>',
    s:'<path d="M13 2.5 4 14.5h6l-1 8 9-12h-6l1-8Z"/>',
    sw:'<path d="M10.7 14.5l3.1-4.2"/>'},
  breath:{
    fl:'<path d="M10.6 8.6c0-1.4-1.1-2.5-2.5-2.5C6 6.1 4.2 8.9 4.2 13c0 3.5.8 5.2 2.6 5.2 2.1 0 3.8-2 3.8-4.5V8.6Z"/><path d="M13.4 8.6c0-1.4 1.1-2.5 2.5-2.5 2.1 0 3.9 2.8 3.9 6.9 0 3.5-.8 5.2-2.6 5.2-2.1 0-3.8-2-3.8-4.5V8.6Z"/>',
  ...
  recovery:{
    fl:'<path d="M11 4.6l1.6 4.3 4.3 1.6-4.3 1.6L11 16.4l-1.6-4.3-4.3-1.6 4.3-1.6L11 4.6Z"/><path d="M17.9 14.9l.7 1.9 1.9.7-1.9.7-.7 1.9-.7-1.9-1.9-.7 1.9-.7.7-1.9Z"/><circle cx="6.2" cy="18" r=".65"/>',
  ...
  hydration:{
    fl:'<path d="M12 3.5c3 3.9 5.5 6.5 5.5 9.6a5.5 5.5 0 0 1-11 0c0-3.1 2.5-5.7 5.5-9.6Z"/>',
  ...
  /* ─────────── COACH & SUIVI ─────────── */
  coachDuo:{
    fl:'<path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h11A2.5 2.5 0 0 1 20 6.5v7a2.5 2.5 0 0 1-2.5 2.5H13l-4 4v-4H6.5A2.5 2.5 0 0 1 4 13.5v-7Z"/>',
    ...
    dw:'<path d="M10.4 6.9l.85 2.35 2.35.85-2.35.85-.85 2.35-.85-2.35-2.35-.85 2.35-.85.85-2.35Z"/>'},
  goal:{
    fl:'<circle cx="10.8" cy="13.2" r="4"/>',
  ...
  progress:{
    fl:'<path d="M5.5 20v-5.2l4.3-3.8 3.4 2.9 6.3-5.9V20Z"/>',
  ...
  streak:{
    fl:'<path d="M12 2.6c1 3-1 4.5-2 6-1.2 1.8-1.5 3.6-.5 5.5-2-.5-3.2-2-3.4-3.9C4.6 11.7 4 13.4 4 15.1a8 8 0 0 0 16 0c0-5.4-4.5-7.4-8-12.5Z"/>',
  ...
  trophyDuo:{
    fl:'<path d="M7 4h10v4a5 5 0 0 1-10 0V4Z"/><path d="M9 20h6l-.6-3.5h-4.8L9 20Z"/>',
  ...
  badge:{
    fl:'<circle cx="12" cy="9" r="5"/><path d="M8.5 13 7 21l5-2.8L17 21l-1.5-8c-1.1.65-2.3 1-3.5 1s-2.4-.35-3.5-1Z"/>',
  ...
  plan:{
    fl:'<rect x="9" y="3" width="6" height="3.6" rx="1.1"/><rect x="8.3" y="10.4" width="2.3" height="2.3" rx=".6"/>',
  ...
  calendarDuo:{
    fl:'<path d="M4 7.7A2.2 2.2 0 0 1 6.2 5.5h11.6A2.2 2.2 0 0 1 20 7.7V10H4V7.7Z"/><rect x="14.2" y="15.7" width="2.8" height="2.8" rx=".75"/><circle cx="8.5" cy="13.6" r=".58"/><circle cx="12" cy="13.6" r=".58"/><circle cx="15.6" cy="13.6" r=".58"/><circle cx="8.5" cy="17.1" r=".58"/><circle cx="12" cy="17.1" r=".58"/>',
    s:'<rect x="4" y="5.5" width="16" height="15" rx="2.2"/><path d="M4 10h16M8.5 3.5v4M15.5 3.5v4"/>'},
};

export function IDuo({ name, size = 24, ink = "#101318", blue = "#3C5BFF", detail = "#FFFFFF", onDark = false, style, ...rest }) {
  const d = DUO[name];
  if (!d) return null;
  const st = onDark ? "#F6F7F9" : ink;
  const html =
    `<g fill="${blue}" stroke="none">${d.fl || ""}</g>` +
    ...
    `<g fill="none" stroke="${detail}" stroke-width="1.15" stroke-linecap="round" stroke-linejoin="round">${d.sw || ""}</g>` +
    `<g fill="${detail}" stroke="none">${d.dw || ""}</g>`;
  return (
    <svg
...
export const DUO_NAMES = Object.keys(DUO);
