...
const P = {
  muscle:    { s:"M5.2 17.8c-.9-2.4-.4-5 1.4-6.8l2.2-2.2a3.4 3.4 0 0 1 2.4-1h1.4a3.4 3.4 0 0 0 2.4-1L16.6 5.4c1.4 1.6 2 3.8 1.6 5.9-.5 2.6-2.4 4.7-4.9 5.6-2.9 1.1-6.2.5-8.1-1.1", raw:
               '<path d="M8.4 12.4c1.6-.8 3.5-.6 4.9.5"/>' },
  barbell:   { s:"M4 12h16M6.6 8.4v7.2M17.4 8.4v7.2", raw:
               '<rect x="2" y="9.6" width="2.6" height="4.8" rx=".9"/><rect x="19.4" y="9.6" width="2.6" height="4.8" rx=".9"/><rect x="5" y="7.2" width="1.8" height="9.6" rx=".8"/><rect x="17.2" y="7.2" width="1.8" height="9.6" rx=".8"/>' },
  // ── Ajouts : matériel, zones anatomiques et navigation ───────────────────
  // Tracés maison, cohérents avec la grille 24×24 et le stroke du reste du set.
  building:  { s:"M4 20.5V6.2a1.2 1.2 0 0 1 1.2-1.2h6.1a1.2 1.2 0 0 1 1.2 1.2v14.3M12.5 20.5V10.4a1.2 1.2 0 0 1 1.2-1.2h5.1a1.2 1.2 0 0 1 1.2 1.2v10.1M2.8 20.5h18.4M6.8 8.2h2.6M6.8 11.6h2.6M6.8 15h2.6M15.4 12.6h2.2M15.4 16h2.2" },
  band:      { s:"M6.4 5.6c-2.4 2-2.4 10.8 0 12.8M17.6 5.6c2.4 2 2.4 10.8 0 12.8M6.4 5.6h11.2M6.4 18.4h11.2M9.2 9.2c1.6 1.2 4 1.2 5.6 0M9.2 14.8c1.6-1.2 4-1.2 5.6 0" },
  pullup:    { s:"M3 5.5h18M6.5 5.5v3.2M17.5 5.5v3.2M12 9.4a1.9 1.9 0 1 0 0-3.8M9.4 8.7l1.4 4.1M14.6 8.7l-1.4 4.1M10.8 12.8v3.4l-1.2 3.6M13.2 12.8v3.4l1.2 3.6" },
  gear:      { s:"M12 15.1a3.1 3.1 0 1 0 0-6.2 3.1 3.1 0 0 0 0 6.2Z", raw:
               '<path d="M19.1 14.4a1.4 1.4 0 0 0 .3 1.5l.1.1a1.7 1.7 0 1 1-2.4 2.4l-.1-.1a1.4 1.4 0 0 0-1.5-.3 1.4 1.4 0 0 0-.9 1.3v.2a1.7 1.7 0 1 1-3.4 0v-.1a1.4 1.4 0 0 0-.9-1.3 1.4 1.4 0 0 0-1.5.3l-.1.1a1.7 1.7 0 1 1-2.4-2.4l.1-.1a1.4 1.4 0 0 0 .3-1.5 1.4 1.4 0 0 0-1.3-.9h-.2a1.7 1.7 0 1 1 0-3.4h.1a1.4 1.4 0 0 0 1.3-.9 1.4 1.4 0 0 0-.3-1.5l-.1-.1a1.7 1.7 0 1 1 2.4-2.4l.1.1a1.4 1.4 0 0 0 1.5.3h.1a1.4 1.4 0 0 0 .9-1.3v-.2a1.7 1.7 0 1 1 3.4 0v.1a1.4 1.4 0 0 0 .9 1.3 1.4 1.4 0 0 0 1.5-.3l.1-.1a1.7 1.7 0 1 1 2.4 2.4l-.1.1a1.4 1.4 0 0 0-.3 1.5v.1a1.4 1.4 0 0 0 1.3.9h.2a1.7 1.7 0 1 1 0 3.4h-.1a1.4 1.4 0 0 0-1.3.9Z"/>' },
  pulse:     { s:"M2.8 12h4.1l2.1-6.3 4.3 12.6 2.1-6.3h5.8" },
  spine:     { s:"M12 3.2v17.6M9.2 5.4h5.6M8.6 8.4h6.8M8.2 11.4h7.6M8.6 14.4h6.8M9.2 17.4h5.6" },
  shoulder:  { s:"M7.4 20.4v-4.6a4.6 4.6 0 0 1 4.6-4.6h1.2M6.2 10.2a3.4 3.4 0 1 0 0-6.8 3.4 3.4 0 0 0 0 6.8Z", raw:
               '<path d="M13.2 11.2a4.4 4.4 0 0 1 4.4 4.4v4.8"/><path d="M9.6 8.6c1.4-1.5 3.4-2.2 5.4-1.8"/>' },
  knee:      { s:"M9 3.2v5.4a3 3 0 0 0 .9 2.1l1.2 1.2a3 3 0 0 1 .9 2.1v6M15 3.2v5.4a3 3 0 0 1-.9 2.1l-1.2 1.2", raw:
...
const DUO = {
  ...
  yoga:{ fl:'<circle cx="12" cy="4.9" r="1.95"/>',
    s:'<path d="M12 6.8c.9 2.1 1.3 4.2.7 6.4l-1.3 5.6"/><path d="M12.4 7.6 17.4 4"/><path d="M11 8.3 8 12.6"/><path d="M12.2 13.4 8.4 16.2"/><path d="M12.9 13.4 16.6 16.6"/>' },
