  ...
  return (
    <div style={{marginTop:24}}>
      ...
      <div style={{display:'flex',gap:8}}>
        ...
        {/* Séances */}
        <div style={{flex:1,background:C.s1,border:'1px solid rgba(0,0,0,0.06)',borderRadius:16,padding:'14px 13px',minWidth:0}}>
          <div style={{...ey,marginBottom:10}}>Séances</div>
          <div style={{fontFamily:DISPLAY,fontSize:28,fontWeight:700,color:C.text,letterSpacing:-1,lineHeight:1,...NUM}}>
            {stats.validated}
            <span style={{fontSize:13,fontWeight:400,color:'#9CA3AF',marginLeft:2}}>/{stats.planned}</span>
          </div>
          <div style={{fontSize:10.5,fontWeight:700,marginTop:8,fontFamily:DISPLAY,
            color: stats.validated>0&&stats.diff>=0 ? '#10B981' : '#F87171', ...NUM}}>
        ...
        {/* Assiduité */}
        <div style={{flex:1,background:C.s1,border:'1px solid rgba(0,0,0,0.06)',borderRadius:16,padding:'14px 13px',minWidth:0}}>
          <div style={{...ey,marginBottom:10}}>Assiduité</div>
          <div style={{fontFamily:DISPLAY,fontSize:28,fontWeight:700,color:C.text,letterSpacing:-1,lineHeight:1,...NUM}}>
            {stats.assiduite}
            <span style={{fontSize:13,fontWeight:400,color:'#9CA3AF',marginLeft:1}}>%</span>
          </div>
          <div style={{height:7,background:'rgba(0,0,0,0.05)',borderRadius:5,overflow:'hidden',marginTop:9}}>
