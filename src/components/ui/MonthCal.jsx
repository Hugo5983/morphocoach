...
function BilanMois({ sessions, year, month, currentWeek }) {
  ...
  return (
    <div style={{marginTop:24}}>
      ...
      {/* ── Séances ── */}
      <div style={{background:C.s1,border:'1px solid rgba(0,0,0,0.06)',borderRadius:16,padding:'15px 14px',marginBottom:8}}>
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
          <div style={{...ey}}>Séances</div>
      ...
      {/* ── Assiduité ── */}
      <div style={{background:C.s1,border:'1px solid rgba(0,0,0,0.06)',borderRadius:16,padding:'15px 14px'}}>
