...
import { C, DARK, FONT, INT, SERIF, SESS_COLORS } from "../../data/constants.js";
  ...
  return (
    <div style={{marginTop:24}}>
      ...
      <div style={{display:'flex',gap:8}}>
        ...
        {/* Séances */}
        <div style={{flex:1,background:C.s1,border:'1px solid rgba(0,0,0,0.05)',borderRadius:16,padding:'16px 12px',minWidth:0}}>
