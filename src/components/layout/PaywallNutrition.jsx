    ...
    <div style={{
      ...
      <Card padding="none" style={{
        ...
        <div style={{ textAlign:"center", marginBottom:20, position:"relative" }}>
          ...
          <div style={{ fontFamily:SERIF, fontSize:26, color:C.text, letterSpacing:-0.5, lineHeight:1.25, marginBottom:8 }}>
            Mange mieux,<br/>
            <span style={{ fontStyle:"italic" }}>progresse plus vite</span>
          </div>
          <div style={{ fontSize:13, color:C.mid, fontFamily:FONT, lineHeight:1.55 }}>
