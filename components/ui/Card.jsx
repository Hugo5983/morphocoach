...
const VARIANTS = {
  ...
  accent:  { background: C.s1, border:`1px solid ${C.accent}`, boxShadow:"0 4px 14px rgba(60,91,255,0.12)" },
  success: { background:"rgba(18,183,106,0.08)", border:"1px solid rgba(18,183,106,0.25)" },
  danger:  { background:"rgba(60,91,255,0.08)", border:"1px solid rgba(60,91,255,0.25)" },
